  ...
  await prisma.category.createMany({
    data: [
      ...
      // 1. PHYSICAL (🏃)
      {
        ...
        description: "Développement sécurisé et continu des voies cyclables pour encourager le vélo en ville.",
      ...
      },
      {
        ...
        description: "Installation d’équipements sportifs accessibles gratuitement dans les parcs urbains.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Adaptation des bâtiments et espaces publics aux personnes à mobilité réduite.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Surveillance et entretien des terrains sportifs urbains pour prévenir les accidents.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Promotion d’activités physiques communautaires et compétitions de quartier.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.PHYSICAL
      },
      ...
      // 2. COGNITIVE (🧠)
      {
        ...
        description: "Optimisation des panneaux et informations urbaines pour faciliter la navigation.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Création de zones calmes et naturelles en milieu urbain pour la concentration et la réflexion.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
        ...
        description: "Accès facilité à des ressources culturelles et éducatives.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
      ...
      },
      {
        ...
        description: "Installation d’équipements urbains interactifs pour stimuler la curiosité.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE
      },
      ...
      // 3. SOCIAL (🤝)
      {
        ...
        description: "Création de lieux dédiés aux échanges et activités sociales de proximité.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Faciliter l’intégration sociale par des événements et accompagnements.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL
      },
      {
        ...
        description: "Actions ciblées pour maintenir le lien social en milieu rural.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL
      },
      {
        ...
        description: "Encouragement des projets de logement partagé entre générations.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL
      },
      {
        ...
        description: "Dynamisation de la vie locale par des manifestations festives.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL
      },
      ...
      // 4. SENSORY (👁️👂)
      {
        ...
        description: "Mise en place de zones calmes et limitation des bruits urbains.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Sécurisation des rues par un éclairage adapté et respectueux.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SENSORY
      },
      {
        ...
        description: "Jardins multisensoriels pour favoriser le bien-être et la relaxation.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SENSORY
      },
      {
        ...
        description: "Adaptation des parcours piétons pour personnes déficientes visuelles.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SENSORY
      },
      {
        ...
        description: "Gestion des déchets et industries pour limiter les odeurs désagréables.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SENSORY
      },
      ...
      // 5. PHYSICAL_WELLNESS (🧘‍♂️)
      {
        ...
        description: "Création d’espaces propices à la relaxation et au ressourcement.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Réglementation sur le bruit nocturne et qualité de l’air.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Installation de points d’eau potable dans les espaces urbains.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
      ...
      // 6. EMOTIONAL_WELLNESS (😊)
      {
        ...
        description: "Centres d’écoute et de parole pour le bien-être émotionnel des habitants.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Sessions collectives pour apprendre à gérer le stress et l’anxiété.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
        ...
        description: "Activités artistiques pour favoriser l’expression des émotions.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
        ...
        description: "Espaces calmes pour se détendre et retrouver son équilibre émotionnel.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
        ...
        description: "Rencontres régulières pour partager expériences et renforcer la résilience.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      ...
      // 7. SOCIAL_WELLNESS (🤗)
      {
        ...
        description: "Bancs, cafés et jardins pour favoriser les interactions sociales.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Plateformes et initiatives pour favoriser l’aide entre voisins.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Activités rassemblant toutes les générations pour renforcer les liens sociaux.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Formation à la gestion des conflits dans la vie de quartier.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Soutien aux groupes sociaux pour dynamiser la vie locale.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      ...
      // 8. INTELLECTUAL_WELLNESS (🧩)
      {
        ...
        description: "Lieux publics dédiés au travail intellectuel et à l’innovation.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Accès facilité à des ressources culturelles et récréatives.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Organisation régulière d’événements pour nourrir l’esprit critique.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
        ...
        description: "Espaces urbains préservés du bruit pour favoriser la réflexion.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      ...
      // 9. FINANCIAL_WELLNESS (💰)
      {
        ...
        description: "Ateliers et conseils pour mieux gérer ses finances personnelles.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Faciliter l’accès à des ressources financières pour les projets locaux.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Encouragement des circuits courts et de la consommation locale.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      ...
      // 10. ENVIRONMENTAL_WELLNESS (🌱)
      {
        ...
        description: "Espaces verts gérés collectivement pour un contact direct avec la nature.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Organisation de nettoyages et de sensibilisation à la propreté.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
        ...
        description: "Mise en place de composteurs de quartier pour réduire les déchets.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Rencontres pour échanger sur le sens de la vie et la spiritualité.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      {
        ...
        description: "Sessions pour apprendre à vivre l’instant présent au quotidien.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Techniques et méthodes pour améliorer la mémoire et la concentration.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        ...
        description: "Programmes pour découvrir de nouvelles langues et traditions.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        ...
        description: "Clubs pour lire, discuter et développer la pensée critique.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        ...
        description: "Utilisation d’applications et d'outils numériques pour le cerveau.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      ...
      },
      {
        ...
        description: "Adaptation de la pleine conscience dans la vie rurale et citadine",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS
      },
      ...
      },
      {
        ...
        description: "Adaptations pour personnes à mobilité réduite en milieu rural.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      {
      ...
      },
      {
        ...
        description: "Mesures pour garantir la sécurité des bâtiments et installations.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      {
      ...
      // 17. COMMUNITY_SERVICES (🏢)
      {
        ...
        description: "Lieux offrant aide sociale, information et accompagnement.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Technologies pour améliorer la gestion rurale (capteurs, IoT).",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
      ...
      // 22. COLLABORATION (🤝)
      {
        ...
        description: "Faciliter la coopération entre associations, entreprises, citoyens.",
        typeId: ECategoryType.URBAN_ISSUE,
      ...
      },
      {
        ...
        description: "Actions communes pour renforcer la cohésion territoriale.",
        typeId: ECategoryType.URBAN_ISSUE,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
...
export default seedUrbanIssues;