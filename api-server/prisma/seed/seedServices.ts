  ...
  await prisma.category.createMany({
    data: [
      ...
      },
      {
        ...
        description: "Accompagnement pour troubles spécifiques (TDAH, Alzheimer).",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
      ...
      // SENSORY (4)
      {
        ...
        description: "Services pour malentendants (aides techniques, interprètes).",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Résolution des conflits entre locataires et propriétaires.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.HOUSING_SUPPORT
      },
      ...
      // Chapitre 17 — COMMUNITY_SERVICES (Services communautaires urbains 🏢)
      {
        ...
        description: "Espaces physiques dédiés aux rencontres, événements et activités pour la population locale.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Services de prêt de livres, accès à la documentation et aux ressources numériques pour tous.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Accompagnement des personnes en difficulté (aide alimentaire, orientation, insertion).",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Organisation et soutien d’événements culturels, artistiques ou festifs pour la communauté.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Appui administratif, logistique et financier aux associations à but non lucratif.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      ...
      // ♻️ WASTE_MANAGEMENT (Gestion des déchets urbains)
      {
        ...
        description: "Services réguliers de ramassage des ordures domestiques dans les quartiers.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Mise en place et gestion des systèmes de tri pour valoriser les déchets recyclables.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      {
        ...
        description: "Espaces dédiés où les habitants peuvent déposer des déchets volumineux ou spécifiques.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      {
        ...
        description: "Actions éducatives pour encourager la réduction et le tri des déchets.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      {
        ...
        description: "Collecte et traitement sécurisé des déchets chimiques, électroniques ou toxiques.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      ...
      // 🚀 INNOVATION (Projets d’innovation et technologie )
      {
        ...
        description: "Espaces et services d’accompagnement pour les jeunes entreprises innovantes.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Centres dédiés à l’expérimentation et au développement de nouvelles technologies.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
        ...
        description: "Aides financières et subventions pour encourager la recherche et l’innovation.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
        ...
        description: "Cours et ateliers pour développer les compétences numériques et techniques.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
        ...
        description: "Organisation de compétitions et rencontres pour stimuler la créativité et l’innovation.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.INNOVATION
      },
      ...
      // 🛠️ CONSTRUCTION (Projets de construction et aménagement)
      {
        ...
        description: "Travaux visant à moderniser et sécuriser les infrastructures publiques.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Projets intégrant des principes écologiques dans la planification des espaces urbains.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      {
        ...
        description: "Réalisation de logements accessibles pour les populations à revenus modestes.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      {
        ...
        description: "Adaptation des infrastructures pour faciliter l’accès aux personnes à mobilité réduite.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      {
        ...
        description: "Création ou amélioration d’équipements pour les activités physiques et sportives.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      ...
      // 🌍 SUSTAINABILITY (Projets environnementaux et durables)
      {
        ...
        description: "Initiatives pour encourager l’utilisation de sources d’énergie propres et renouvelables.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Projets visant à protéger et gérer les ressources comme l’eau, les sols et les forêts.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      {
        ...
        description: "Actions concrètes pour diminuer l’empreinte carbone des activités humaines.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      {
        ...
        description: "Programmes éducatifs sur l’impact environnemental des choix quotidiens.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      {
        ...
        description: "Mise en place de systèmes de recyclage et de réutilisation des matériaux.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      ...
      // 🤝 COLLABORATION (Projets collaboratifs)
      {
        ...
        description: "Espaces numériques favorisant la collaboration entre individus pour concevoir des projets communs.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Initiatives permettant d’échanger savoir-faire et expertises entre membres.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
        ...
        description: "Actions où la communauté s’implique directement dans la réalisation de projets locaux.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
        ...
        description: "Sessions de travail collectif pour favoriser l’innovation et l’apprentissage partagé.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
        ...
        description: "Mise en place d’alliances entre organisations pour soutenir des objectifs communs.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COLLABORATION
      },
      ...
      // 🎯 PERSONAL_DEVELOPMENT (Projets personnels de développement)
      {
        ...
        description: "Services d’accompagnement personnalisé pour atteindre des objectifs de vie.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Ateliers et cours pour développer ses compétences en gestion et motivation.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PERSONAL_DEVELOPMENT
      },
      {
        ...
        description: "Outils et méthodes pour améliorer l’organisation personnelle.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PERSONAL_DEVELOPMENT
      },
      {
        ...
        description: "Exercices pour mieux gérer ses émotions et renforcer l’intelligence émotionnelle.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PERSONAL_DEVELOPMENT
      },
      {
        ...
        description: "Conseils et accompagnement pour construire un parcours professionnel adapté.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PERSONAL_DEVELOPMENT
      },
      ...
      // 📖 GUIDES (Guides et manuels)
      {
        ...
        description: "Documentation détaillée sur les bonnes pratiques pour préserver sa santé.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Ressources pour améliorer sa confiance, sa motivation et son bien-être.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.GUIDES
      },
      {
        ...
        description: "Instructions pas à pas pour maîtriser des outils numériques ou artisanaux.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.GUIDES
      },
      {
        ...
        description: "Informations sur les gestes écoresponsables et la préservation de la nature.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.GUIDES
      },
      {
        ...
        description: "Explications claires pour accéder aux aides et services administratifs.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.GUIDES
      },
      ...
      // 🎥 VIDEOS (Vidéos éducatives)
      {
        ...
        description: "Capsules pour comprendre les bases d’une alimentation saine.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Vidéos guidant la pratique sportive à domicile ou en extérieur.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.VIDEOS
      },
      {
        ...
        description: "Interventions d’experts sur la gestion du stress et la santé mentale.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.VIDEOS
      },
      {
        ...
        description: "Documentaires et reportages pour sensibiliser aux enjeux écologiques.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.VIDEOS
      },
      {
        ...
        description: "Séances de création artistique ou manuelle à reproduire chez soi.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.VIDEOS
      },
      ...
      },
      {
        ...
        description: "Analyses des nouvelles pratiques pour améliorer la vie en communauté.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.ARTICLES
      },
      {
        ...
        description: "Textes traitant des pratiques responsables et de la transition écologique.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.ARTICLES
      },
      {
        ...
        description: "Articles explorant les comportements et interactions humaines.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.ARTICLES
      },
      {
        ...
        description: "Synthèses et conseils basés sur les dernières données scientifiques.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.ARTICLES
      },
      ...
      // 🎙️ PODCASTS (Podcasts et interviews)
      {
        ...
        description: "Discussions approfondies sur la gestion du stress et la psychologie.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Échanges entre spécialistes sur les enjeux écologiques actuels.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PODCASTS
      },
      {
        ...
        description: "Épisodes dédiés à la motivation, à la productivité et au bien-être.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PODCASTS
      },
      {
        ...
        description: "Présentation des nouvelles idées et projets impactants dans la société.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PODCASTS
      },
      ...
      // 📊 INFOGRAPHICS (Infographies et données visuelles)
      {
        ...
        description: "Visualisations claires des données épidémiologiques et sanitaires.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Infographies localisant les aides disponibles dans les quartiers.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.INFOGRAPHICS
      },
      {
      ...
      },
      {
        ...
        description: "Diagrammes pour comprendre les mécanismes du stress et de l’anxiété.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.INFOGRAPHICS
      },
      ...
      },
      {
        ...
        description: "Services pour la récupération après une blessure ou chirurgie.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.HEALTHCARE
      },
      ...
      // 🧑‍🏫 EDUCATION (Services éducatifs et formations)
      {
        ...
        description: "Ateliers pour apprendre ou perfectionner une langue étrangère.",
        typeId: ECategoryType.SERVICE,
      ...
      // 🛒 DAILY_HELP (Aides quotidiennes : courses, ménage)
      {
        ...
        description: "Service de préparation et livraison d’aliments et produits essentiels.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.DAILY_HELP
      },
      {
        ...
        description: "Intervention pour le nettoyage et l’organisation du domicile.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.DAILY_HELP
      },
      {
      ...
      },
      {
        ...
        description: "Soutien pour lettres, recours ou formulaires administratifs.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.ADMINISTRATIVE_HELP
      },
      {
      ...
      },
      {
        ...
        description: "Aide au montage de dossiers pour allocations ou aides diverses.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.ADMINISTRATIVE_HELP
      },
      ...
      // 🤝 PSYCHOLOGICAL_SUPPORT (Soutien psychologique et émotionnel)
      {
        ...
        description: "Sessions privées pour accompagner des difficultés personnelles.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.PSYCHOLOGICAL_SUPPORT
      },
      {
      ...
      // 🏠 HOUSING_SUPPORT (Aide au logement d’urgence)
      {
        ...
        description: "Offres de logement provisoire pour personnes en difficulté.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.HOUSING_SUPPORT
      },
      {
      ...
      // PHYSICAL_ACTIVITY (Activités physiques)
      {
        ...
        description: "Encouragement à la marche régulière adaptée à tous les âges.",
        typeId: ECategoryType.SERVICE,
      ...
      // COGNITIVE_TRAINING (Programmes cognitifs)
      {
        ...
        description: "Exercices pour stimuler la mémoire à court et long terme.",
        typeId: ECategoryType.SERVICE,
      ...
      },
      {
        ...
        description: "Cours et ateliers pour développer les capacités linguistiques.",
        typeId: ECategoryType.SERVICE,
        chapterId: ECategoryChapter.COGNITIVE_TRAINING
      },
      {
