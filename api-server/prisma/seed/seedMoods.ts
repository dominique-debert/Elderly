...
const moods = [
  { name: 'Heureux', valence: 'positive' as Valence, intensity: 4, color: '#FFD700', description: 'Sentiment de joie et de satisfaction' },         // jaune or
  { name: 'Épanoui', valence: 'positive' as Valence, intensity: 4, color: '#FFCC00', description: 'Sensation de plénitude et de bien-être' },
