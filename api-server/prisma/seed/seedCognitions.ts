  ...
  await prisma.category.createMany({
    data: [
      ...
      // 🏃 PHYSICAL – Activités physiques et sportives
      {
        ...
        description: "Analyse et planification tactique dans les sports collectifs ou individuels.",
      ...
      },      
      {
        ...
        description: "Apprentissage et répétition de séquences gestuelles complexes.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.PHYSICAL_ACTIVITY
      },      
      {
      ...
      // 👁️👂 SENSORY – Activités sensorielles
      {
        ...
        description: "Traitement combiné des signaux visuels, auditifs et tactiles.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Identifier des différences fines entre stimuli sensoriels.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SENSORY
      },      
      {
      ...
      },      
      {
        ...
        description: "Concentration sur un stimulus précis malgré les distractions.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SENSORY
      },      
      ...
      // 🧘‍♂️ PHYSICAL_WELLNESS – Bien-être physique
      {
        ...
        description: "Évaluation cognitive de son état physique (tensions, douleurs).",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Utilisation d’images mentales pour optimiser la performance.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },      
      {
      ...
      // 😊 EMOTIONAL_WELLNESS – Bien-être émotionnel et gestion du stress
      {
        ...
        description: "Utilisation de stratégies cognitives pour moduler ses émotions.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Modifier la perception d’une situation stressante pour réduire son impact émotionnel.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },      
      {
        ...
        description: "Identifier et nommer avec précision ses propres états affectifs.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },      
      {
        ...
        description: "Prévoir l’effet émotionnel de futurs événements pour mieux les gérer.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },      
      {
        ...
        description: "Prise de recul cognitive face aux pensées automatiques ou négatives.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },      
      ...
      // 🤗 SOCIAL_WELLNESS – Bien-être social et sentiment d’appartenance
      {
        ...
        description: "Compréhension des états mentaux des autres dans les interactions sociales.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Se souvenir d’informations pertinentes sur les personnes et les relations.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },      
      {
        ...
        description: "Évaluer correctement les dynamiques d’un groupe ou d’un réseau social.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },      
      {
      ...
      },      
      {
        ...
        description: "Capacité à attribuer des croyances et intentions aux autres.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },      
      ...
      // 🧩 INTELLECTUAL_WELLNESS – Bien-être intellectuel et cognitif
      {
        ...
        description: "Motivation intrinsèque à explorer et apprendre de nouveaux savoirs.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Capacité à évaluer objectivement les informations et leurs sources.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },      
      {
        ...
        description: "Structuration mentale logique de connaissances complexes.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },      
      {
      ...
      },      
      {
        ...
        description: "Analyser les coûts-bénéfices de ses choix de consommation.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },      
      {
      ...
      },      
      {
        ...
        description: "Se souvenir de transactions, échéances et engagements financiers.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },      
      {
        ...
        description: "Prévoir les conséquences économiques de comportements actuels.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },      
      ...
      // 🌱 ENVIRONMENTAL_WELLNESS – Bien-être environnemental
      {
        ...
        description: "Comprendre les relations causales entre comportements humains et nature.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Choisir des actions bénéfiques pour l’environnement après réflexion.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },      
      {
      ...
      // 🕉️ SPIRITUAL_WELLNESS – Bien-être spirituel
      {
        ...
        description: "Capacité à réfléchir sur le sens de la vie, la mort et la place de l’individu dans le monde.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Compréhension des métaphores, rituels et récits spirituels.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },      
      {
        ...
        description: "Exploration cognitive de son identité, ses valeurs et croyances.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },      
      {
        ...
        description: "Construction personnelle de repères spirituels cohérents.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },      
      {
        ...
        description: "Capacité à conceptualiser l’infini, la transcendance ou des réalités non tangibles.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },      
      ...
      // 🧮 COGNITIVE_ACTIVITY – Activités cognitives spécifiques
      {
        ...
        description: "Activités impliquant logique, raisonnement spatial ou mathématique.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },      
      {
        ...
        description: "Échecs, go, jeux nécessitant planification et anticipation.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        ...
        description: "Exercices de mémoire à court et long terme (mots, chiffres, objets).",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        ...
        description: "Activités ciblées pour renforcer concentration et vigilance.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        ...
        description: "Résolution de problèmes numériques ou logiques complexes.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      ...
      // 🧘‍♀️ COGNITIVE_WELLNESS – Bien-être cognitif
      {
        ...
        description: "Activités visant à maintenir ou améliorer les fonctions mentales.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Capacité à alterner stimulation cognitive et repos mental.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS
      },
      {
        ...
        description: "Stratégies d’apprentissage, de mémorisation ou de concentration.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS
      },
      {
      ...
      // 🏙️ URBAN_INFRASTRUCTURE – Infrastructures urbaines
      {
        ...
        description: "Compréhension cognitive de l’espace urbain et de sa structure.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Capacité à se repérer et à planifier des trajets en ville.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      {
      ...
      },
      {
        ...
        description: "Planification cognitive de lieux optimisés pour les usagers.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      ...
      // 🚦 TRANSPORTATION – Mobilité et transports urbains
      {
        ...
        description: "Choix optimal de trajets en fonction de contraintes cognitives.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Adapter ses déplacements dans un environnement dynamique.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      {
        ...
        description: "Réagir cognitivement aux imprévus (retards, changements).",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      ...
      // 🌿 URBAN_ENVIRONMENT – Espaces verts et environnement urbain
      {
        ...
        description: "Capacité à représenter cognitivement les lieux naturels en ville.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Raisonnement sur la gestion de la biodiversité, pollution et qualité de l’air.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      {
        ...
        description: "Évaluation cognitive des conséquences des activités humaines sur l’environnement urbain.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      {
        ...
        description: "Choisir consciemment des itinéraires qui incluent ou favorisent les espaces naturels.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      {
        ...
        description: "Capacité à repérer et interpréter les signaux naturels ou urbains (changement de saisons, pollution visuelle…).",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      ...
      // 🏢 COMMUNITY_SERVICES – Services communautaires urbains
      {
        ...
        description: "Raisonnement basé sur l’analyse des besoins sociaux locaux.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Compréhension des circuits d’aide et de leur organisation.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Capacité à s’orienter dans des systèmes complexes d’accès aux services.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Évaluation logique de l’adéquation entre ressources disponibles et besoins réels.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Intégration des connaissances liées à la citoyenneté et la participation collective.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      ...
      // ♻️ WASTE_MANAGEMENT – Gestion des déchets urbains
      {
        ...
        description: "Reconnaissance et catégorisation correcte des types de déchets.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Jugement cognitif des pratiques individuelles sur l’environnement.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      {
      ...
      },
      {
        ...
        description: "Intégration conceptuelle du principe de réutilisation et durabilité.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      ...
      // 🚀 INNOVATION – Projets d’innovation et technologie
      {
        ...
        description: "Capacité à produire plusieurs idées originales pour un même problème.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Analyse rationnelle de leur utilité, efficacité et éthique.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
        ...
        description: "Créer des représentations abstraites de systèmes ou concepts innovants.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
        ...
        description: "Approche cognitive non conventionnelle pour surmonter des obstacles.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
        ...
        description: "Application de connaissances acquises dans de nouveaux contextes.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.INNOVATION
      },
      ...
      // 🛠️ CONSTRUCTION – Projets de construction et aménagement
      {
        ...
        description: "Capacité à imaginer des structures à partir de plans ou schémas.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Compréhension cognitive des plans, consignes et normes de sécurité.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      {
        ...
        description: "Planification logique des étapes d’un chantier ou projet.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      {
      ...
      },
      {
        ...
        description: "Réflexion structurée sur les besoins des usagers et leur traduction en solutions concrètes.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      ...
      // 🌍 SUSTAINABILITY – Projets environnementaux et durables
      {
        ...
        description: "Comprendre les interconnexions entre environnement, économie et société.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        id: 417,
        categoryName: "Projection à long terme",
        description: "Anticiper cognitivement les impacts des décisions durables sur les générations futures.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      {
        ...
        description: "Analyser logiquement les avantages et inconvénients d’une action verte.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      {
        ...
        description: "Jugement moral et cognitif sur la responsabilité individuelle et collective.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      {
        ...
        description: "Identifier et interpréter correctement les informations de durabilité.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.SUSTAINABILITY
      },
      ...
      // 🤝 COLLABORATION – Projets collaboratifs
      {
        ...
        description: "Capacité à intégrer et coordonner les objectifs d’un groupe.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Analyser et peser les options dans un cadre participatif.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
        ...
        description: "Structuration de discours visant à faire avancer un groupe.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
      ...
      // 🎯 PERSONAL_DEVELOPMENT – Projets personnels de développement
      {
        ...
        description: "Capacité à réfléchir sur ses comportements, pensées et schémas mentaux.",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Planification raisonnée d’objectifs spécifiques, mesurables, atteignables…",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.PERSONAL_DEVELOPMENT
      },
      {
      ...
      },
      {
        ...
        description: "Organisation mentale pour maintenir des routines constructives.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.PERSONAL_DEVELOPMENT
      },
      ...
      // 📖 GUIDES – Guides et manuels
      {
        ...
        description: "Capacité à interagir cognitivement avec les contenus (questionnement, reformulation).",
        typeId: ECategoryType.COGNITIVE,
      ...
      },
      {
        ...
        description: "Création de structures internes à partir de consignes écrites.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.GUIDES
      },
      {
      ...
      },
      {
        ...
        description: "Vérification cognitive de l’assimilation correcte du contenu.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.GUIDES
      },
      ...
      },
      {
        ...
        description: "Concentration cognitive sur les éléments pertinents de la vidéo.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.VIDEOS
      },
      {
        ...
        description: "Mémorisation structurée des idées principales en temps réel.",
        typeId: ECategoryType.COGNITIVE,
        chapterId: ECategoryChapter.VIDEOS
      },
      {
