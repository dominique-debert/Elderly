  ...
  await prisma.category.createMany({
    data: [
      ...
      // 🏃 PHYSICAL (Activités physiques et sportives)
      {
        ...
        description: "Aide à préparer des repas adaptés aux besoins énergétiques sportifs.",
      ...
      },
      {
        ...
        description: "Élaboration de plans alimentaires spécifiques pour la performance physique.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Conseils et aide pour une hydratation optimale avant, pendant et après l’effort.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Fourniture d’aliments favorisant la récupération musculaire.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Informations sur les compléments nutritionnels pour sportifs.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL
      },
      ...
      // 🧠 COGNITIVE (Fonctions cognitives et intellectuelles) 
      {
        ...
        description: "Aide à choisir des aliments favorisant la concentration et la mémoire.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Support pour suivre des régimes visant la santé cérébrale.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
      ...
      },
      {
        ...
        description: "Accompagnement nutritionnel pour Alzheimer, démence, etc.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.COGNITIVE
      },
      ...
      },
      {
        ...
        description: "Support lors de repas en communauté avec contraintes spécifiques.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL
      },
      {
        id: 769,
        categoryName: "Facilitation d’accès à une alimentation saine en milieu social",
      ...
      },
      {
        ...
        description: "Aide alimentaire pour personnes avec troubles du goût ou odorat.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SENSORY
      },
      {
      ...
      },
      {
        ...
        description: "Aide aux choix d’aliments pour troubles de mastication/déglutition.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SENSORY
      },
      {
      ...
      },
      {
        ...
        description: "Support dans l’organisation de repas qui évitent les coups de barre.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Conseils sur aliments qui favorisent détente et bien-être.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Aide personnalisée pour maintenir ou atteindre un poids équilibré.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Aide pour intégrer des aliments bénéfiques pour le corps.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      ...
      // 😊 EMOTIONAL_WELLNESS (Bien-être émotionnel) 
      {
        ...
        description: "Support pour éviter les excès liés au stress ou à l’ennui.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Aide pour choisir aliments influant positivement sur l’émotion.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
        id: 782,
        categoryName: "Accompagnement dans les troubles alimentaires émotionnels",
        description: "Soutien nutritionnel en cas d’anorexie, boulimie, compulsions.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Conseils pour éviter les pics glycémiques et leurs effets.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      ...
      {
        id: 785,
        categoryName: "Aide à l’inclusion alimentaire lors d’événements sociaux",
        description: "Support pour proposer des options nutritionnelles diverses.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        id: 786,
        categoryName: "Soutien aux familles dans la préparation de repas équilibrés",
      ...
      {
        id: 787,
        categoryName: "Facilitation de l’accès à une alimentation collective équilibrée",
      ...
      },
      {
        ...
        description: "Ateliers et conseils pour améliorer la nutrition collective.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        id: 789,
        categoryName: "Promotion d’alimentation durable dans les groupes sociaux",
      ...
      // 🧩 INTELLECTUAL_WELLNESS (Bien-être intellectuel) 
      {
        ...
        description: "Ateliers d’information pour mieux comprendre l’impact de la nutrition.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
        id: 791,
        categoryName: "Soutien à la mise en place de routines alimentaires saines",
        description: "Accompagnement pour structurer ses repas de façon intelligente.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
        id: 792,
        categoryName: "Planification nutritionnelle pour la prévention cognitive",
        description: "Conseils pour retarder le déclin intellectuel par la nutrition.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Aide à préparer des repas équilibrés avec un budget limité.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      {
      ...
      {
        id: 801,
        categoryName: "Accompagnement vers une alimentation végétarienne/végane",
        description: "Conseils pour réduire son impact écologique via la nutrition.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
        ...
        description: "Aide pour cuisiner en limitant les emballages et déchets.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Soutien pour cultiver soi-même une partie de son alimentation.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      ...
      {
        id: 806,
        categoryName: "Conseils pour une alimentation consciente et respectueuse",
      ...
      },
      {
        ...
        description: "Aide pour respecter les prescriptions alimentaires spirituelles.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      {
        ...
        description: "Techniques pour intégrer la pleine conscience dans l’acte de manger.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      {
        id: 809,
        categoryName: "Information sur l’alimentation et la connexion corps-esprit",
      ...
      // 💼 SOCIAL_WELLNESS (Bien-être professionnel et engagement) 
      {
        ...
        description: "Soutien pour la rédaction de CV, lettre de motivation et préparation aux entretiens.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Aide à l’intégration dans un nouveau poste ou secteur d’activité.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Aide à mieux concilier responsabilités professionnelles et personnelles.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Ateliers pour explorer ses talents et aspirations professionnelles.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Soutien pour changer de métier ou de projet de vie professionnelle.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      ...
      // 🎨 CREATIVE (Créativité et expression artistique) 
      {
        ...
        description: "Aide à la pratique du dessin, peinture, écriture ou musique.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Animation d’activités favorisant la créativité (bricolage, théâtre, etc.).",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.CREATIVE
      },
      {
      ...
      // 🏠 HOUSING_SUPPORT (Habitat, logement, entretien domestique) 
      {
        ...
        description: "Accompagnement dans les démarches pour trouver un logement adapté.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Aide pour les démarches, les cartons, l’adaptation au nouvel environnement.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.HOUSING_SUPPORT
      },
      {
        ...
        description: "Soutien pour le ménage, le rangement, la maintenance de base.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.HOUSING_SUPPORT
      },
      {
        ...
        description: "Conseil pour adapter le logement aux besoins spécifiques.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.HOUSING_SUPPORT
      },
      {
        ...
        description: "Aide aux demandes d’aides au logement, bail, assurance habitation, etc.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.HOUSING_SUPPORT
      },
      ...
      // 🚗 TRANSPORTATION (Mobilité et déplacements) 
      {
        ...
        description: "Soutien pour organiser les trajets quotidiens ou ponctuels.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Assistance pour comprendre les lignes, acheter des tickets, etc.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      {
        ...
        description: "Conseil pour l’usage des transports adaptés ou services spécialisés.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      {
      ...
      },
      {
        ...
        description: "Accompagnement pour apprendre à se déplacer de manière autonome.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      ...
      },
      {
        ...
        description: "Aide à l’intégration dans une école, démarches administratives.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EDUCATION
      },
      {
        ...
        description: "Soutien dans les démarches pour suivre une formation ou reprendre des études.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EDUCATION
      },
      {
        ...
        description: "Accompagnement des enfants à besoins éducatifs particuliers.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EDUCATION
      },
      {
        ...
        description: "Simplification des cours ou explications complémentaires.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EDUCATION
      },
      ...
      // 🏥 HEALTH (Santé, soins médicaux, bien-être physique global) 
      {
        ...
        description: "Assistance pour trouver un praticien et organiser les visites.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Explications claires des résultats médicaux ou des traitements.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.HEALTHCARE
      },
      {
        ...
        description: "Aide à la prise régulière des médicaments ou suivis médicaux.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.HEALTHCARE
      },
      {
      ...
      // 🧪 INNOVATION (Utilisation des technologies et innovation sociale) 
      {
        ...
        description: "Aide à l’usage des outils informatiques et plateformes numériques.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Aide à la mise en place de dispositifs technologiques adaptés.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.INNOVATION
      },
      {
      ...
      //  — 
      {
        ...
        description: "Facilitation de cercles de parole sur des thématiques diverses.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Encouragement et aide à prendre la parole sur des sujets qui comptent.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.DISCUSSIONS
      },
      {
      ...
      },
      {
        ...
        description: "Aide à la participation à des forums, tables rondes, ou débats publics.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.DISCUSSIONS
      },
      {
        ...
        description: "Facilitation du dialogue entre personnes de cultures différentes.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.DISCUSSIONS
      },
      ...
      // 🛎️ SERVICES (Accès aux services du quotidien) 
      {
        ...
        description: "Soutien pour identifier les ressources disponibles dans son territoire.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Assistance pour remplir des formulaires, déclarations, inscriptions.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Aide pour utiliser les sites web des services publics ou privés.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Conseil pour la gestion des dépenses, aides financières et prestations.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Soutien pour organiser des démarches (CAF, CPAM, Pôle emploi, etc.).",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      ...
      },
      {
        ...
        description: "Activités pour entretenir la mémoire, l’attention, et les capacités mentales.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.ELDERLY_SUPPORT
      },
      {
        ...
        description: "Visites de courtoisie, appels, participation à des groupes sociaux.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.ELDERLY_SUPPORT
      },
      {
        ...
        description: "Conseils pour sécuriser et adapter le logement aux besoins liés à l’âge.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.ELDERLY_SUPPORT
      },
      {
        ...
        description: "Accompagnement des proches aidants dans leur rôle et leur bien-être.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.ELDERLY_SUPPORT
      },
      ...
      // 🚨 EMERGENCY_SERVICES (Soutien en situation d’urgence ou de crise) 
      {
        ...
        description: "Aide à contacter les services d’urgence et assurer la sécurité immédiate.",
        typeId: ECategoryType.HELP,
      ...
      },
      {
        ...
        description: "Soutien pour trouver un logement d’urgence ou un lieu d’accueil.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EMERGENCY_SERVICES
      },
      {
        ...
        description: "Aide à gérer le choc émotionnel après un événement difficile.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EMERGENCY_SERVICES
      },
      {
        ...
        description: "Accompagnement dans les démarches judiciaires ou sociales.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EMERGENCY_SERVICES
      },
      {
        ...
        description: "Appui logistique ou communication avec les structures d’intervention.",
        typeId: ECategoryType.HELP,
        chapterId: ECategoryChapter.EMERGENCY_SERVICES
      },
