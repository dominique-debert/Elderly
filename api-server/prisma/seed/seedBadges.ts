  ...
  await prisma.category.createMany({
    data: [
      ...
      },
      {
        ...
        description: "Pour ceux qui participent à des activités sportives occasionnelles.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Pour les utilisateurs pratiquant une activité physique intense plusieurs fois par semaine.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.PHYSICAL
      },
      ...
      },
      {
        ...
        description: "Pour ceux qui explorent régulièrement de nouveaux sujets intellectuels.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
        ...
        description: "Pour la participation continue à des activités stimulantes mentalement.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.COGNITIVE
      },
      ...
      // 👁️👂 Activités sensorielles (SENSORY)
      {
        ...
        description: "Pour avoir participé à diverses expériences sensorielles.",
        typeId: ECategoryType.BADGE,
      ...
      },
      {
        ...
        description: "Pour l'intégration régulière d'activités impliquant les 5 sens.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.SENSORY
      },
      {
        ...
        description: "Pour l’équilibre entre stimulation visuelle, sonore et tactile.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.SENSORY
      },
      ...
      },
      {
        ...
        description: "Pour l’utilisation régulière de techniques de relaxation.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Pour la mise en place d’habitudes favorisant le bien-être physique.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      ...
      },
      {
        ...
        description: "Pour ceux qui tiennent un journal émotionnel régulièrement.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
      ...
      // 🧩 Bien-être intellectuel (INTELLECTUAL_WELLNESS)
      {
        ...
        description: "Pour les utilisateurs qui lisent des livres/articles fréquemment.",
        typeId: ECategoryType.BADGE,
      ...
      },
      {
        ...
        description: "Pour ceux qui partagent ou initient des idées novatrices.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Pour les utilisateurs qui ont atteint des objectifs financiers.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Pour un engagement dans le tri et la gestion des déchets.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Pour la participation à des activités de développement spirituel.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Pour la progression dans des exercices de pleine conscience.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS
      },
      {
      ...
      // 🏙️ Problématiques d’infrastructures urbaines (URBAN_INFRASTRUCTURE)
      {
        ...
        description: "Pour des propositions ou projets d’amélioration de l’infrastructure.",
        typeId: ECategoryType.BADGE,
      ...
      },
      {
        ...
        description: "Pour des signalements pertinents sur l’état des infrastructures.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      {
      ...
      },
      {
        ...
        description: "Pour un projet innovant avec portée sociale/environnementale.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.INNOVATION
      },
      ...
      // 🛠️ Projets de construction et aménagement (CONSTRUCTION)
      {
        ...
        description: "Pour une implication dans un projet de construction utile.",
        typeId: ECategoryType.BADGE,
      ...
      },
      {
        ...
        description: "Pour la transformation ou l'amélioration d’espaces partagés.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.CONSTRUCTION
      },
      ...
      // 🧑‍🤝‍🧑 Services à la personne (DAILY_HELP)
      {
        ...
        description: "Pour avoir aidé régulièrement une personne en difficulté.",
        typeId: ECategoryType.BADGE,
      ...
      // 🗣️ Discussions, échanges et débats (DISCUSSIONS)
      {
        ...
        description: "Pour la participation à des échanges d’idées constructifs.",
        typeId: ECategoryType.BADGE,
      ...
      },
      {
        ...
        description: "Pour l’attitude bienveillante et l’écoute attentive des autres.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.DISCUSSIONS
      },
      {
      ...
      // 🧓 Soutien aux personnes âgées (ELDERLY_SUPPORT)
      {
        ...
        description: "Pour les visites ou temps passés avec des personnes âgées.",
        typeId: ECategoryType.BADGE,
      ...
      },
      {
        ...
        description: "Pour des initiatives favorisant la diversité et le respect des différences.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.INCLUSION
      },   
      ...
      // 📚 Éducation et apprentissage (EDUCATION)
      {
        ...
        description: "Pour la transmission de connaissances à d'autres utilisateurs.",
        typeId: ECategoryType.BADGE,
      ...
      // 🧪 Santé et prévention (HEALTH)
      {
        ...
        description: "Pour la participation à des campagnes ou gestes préventifs.",
        typeId: ECategoryType.BADGE,
      ...
      },
      {
        ...
        description: "Pour le suivi régulier de sa santé et bien-être physique.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.HEALTHCARE
      },
      {
        ...
        description: "Pour la sensibilisation autour de la santé dans la communauté.",
        typeId: ECategoryType.BADGE,
        chapterId: ECategoryChapter.HEALTHCARE
      },     
