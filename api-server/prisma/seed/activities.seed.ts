  ...
  await prisma.category.createMany({
    data: [
      ...
      // 🏃 ACTIVITY: PHYSICAL (Activités physiques et sportives)
      {
        ...
        description:
          "Séance de gym douce adaptée aux capacités physiques des seniors. Utilisez des exercices simples et doux pour travailler l’équilibre, la souplesse et la force musculaire.",
      ...
      },
      {
        ...
        description:
          "Sorties en groupe pour des promenades dans le quartier ou dans un parc. La marche est une activité physique douce et bénéfique pour la santé cardiovasculaire.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.PHYSICAL,
      },
      {
        ...
        description:
          "Jeux de ballon adaptés aux capacités des seniors, comme le ballon assis ou le mini-golf. Ces jeux stimulent la coordination et la motricité.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.PHYSICAL,
      },
      {
        ...
        categoryName: "Yoga",
        description:
          "Séances de yoga adaptées aux seniors. Le yoga favorise la relaxation, l’équilibre et la flexibilité.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.PHYSICAL,
      },
      {
      ...
      },
      {
        ...
        description:
          "Enchaînement fluide de postures physiques avec respiration.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.PHYSICAL,
      },
      {
        ...
        description:
          "Pratique de sports comme le foot, le basket ou le volley.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.PHYSICAL,
      },
      {
      ...
      },
      {
        ...
        description:
          "Jeux de mémoire comme le Memory ou le jeu des paires. Ces jeux permettent de stimuler la mémoire et l’attention.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      {
      ...
      },
      {
        ...
        description:
          "Activités qui impliquent planification et réflexion (échecs, go).",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      {
      ...
      },
      {
        ...
        description:
          "Rencontres informelles autour d’un thème ou sur des enjeux de société.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.SOCIAL,
      },
      {
      ...
      // 👁️👂 ACTIVITY: SENSORY (Activités sensorielles)
      {
        ...
        description:
          "Ateliers d’aromathérapie où les seniors pourront découvrir les bienfaits des huiles essentielles. Ces ateliers permettent de stimuler l’odorat et de favoriser la détente.",
        typeId: ECategoryType.ACTIVITY,
      ...
      },
      {
        ...
        description:
          "Ateliers de cuisine sensorielle où les seniors pourront découvrir de nouvelles saveurs et textures. Ces ateliers stimulent le goût et favorisent les échanges autour de la nourriture.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Activités de jardinage où les seniors pourront planter des fleurs, cultiver des légumes ou simplement profiter du contact avec la nature. Le jardinage stimule le toucher et favorise la détente.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
        ...
        description:
          "Séances de musicothérapie où les seniors pourront écouter de la musique apaisante et participer à des activités musicales. La musique favorise la relaxation et stimule l’ouïe.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
        ...
        description:
          "Déambulation avec stimulations visuelles, sonores ou olfactives.",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Activités qui stimulent la pensée originale (design, innovation).",
        typeId: ECategoryType.ACTIVITY,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS,
      },
      {
