  ...
  await prisma.category.createMany({
    data: [
      ...
      // PHYSICAL – Compétences physiques
      {
        ...
        description: "Développer la capacité à maintenir un effort prolongé (course, marche rapide, vélo).",
      ...
      },
      {
        ...
        description: "Améliorer la capacité de résistance et de levage via des exercices ciblés.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Travailler la précision et la synchronisation des mouvements du corps.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Étirements et mobilité pour prévenir les blessures et améliorer la posture.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL
      },
      {
        ...
        description: "Exercices de maintien de stabilité pour prévenir les chutes et améliorer l'agilité.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL
      },
      ...
      // COGNITIVE – Compétences cognitives
      {
        ...
        description: "Développer la capacité à analyser et trouver des solutions efficaces.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Améliorer la capacité à retenir et manipuler temporairement des informations.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
        ...
        description: "Renforcer la concentration sur une tâche sans se laisser distraire.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
        ...
        description: "Apprendre à évaluer objectivement des situations et prendre des décisions éclairées.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE
      },
      {
        ...
        description: "S’exercer à passer d’une idée à une autre et s’adapter rapidement.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE
      },
      ...
      // SOCIAL – Compétences sociales
      {
        ...
        description: "Améliorer sa capacité à exprimer ses idées clairement et écouter activement.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Développer la compréhension et la sensibilité aux émotions d’autrui.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL
      },
      {
        ...
        description: "Apprendre à désamorcer les tensions et rechercher des solutions gagnant-gagnant.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL
      },
      {
        ...
        description: "Savoir collaborer efficacement avec d'autres dans un objectif commun.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL
      },
      {
        ...
        description: "Développer des aptitudes à guider, motiver et responsabiliser un groupe.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL
      },
      ...
      // SENSORY – Compétences sensorielles
      {
        ...
        description: "Affiner l'écoute et l’analyse des sons (musique, langues, signaux).",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Détecter les différences et détails dans un environnement visuel complexe.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SENSORY
      },
      {
        ...
        description: "Exercices de reconnaissance et de distinction tactile (textures, formes).",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SENSORY
      },
      {
      ...
      },
      {
        ...
        description: "Coordination de plusieurs sens pour une réponse cohérente (ex. lecture + écoute).",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SENSORY
      },
      ...
      // PHYSICAL_WELLNESS – Compétences de bien-être physique
      {
        ...
        description: "Apprendre à instaurer une routine et optimiser la qualité du sommeil.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Maîtriser des exercices de respiration, yoga ou étirements pour relâcher le corps.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Acquérir les bons gestes pour éviter les troubles musculo-squelettiques.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Identifier les signaux du corps et répondre à ses besoins de repos ou d’effort.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      {
        ...
        description: "Apprendre des techniques non-médicamenteuses pour gérer les douleurs chroniques.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS
      },
      ...
      // EMOTIONAL_WELLNESS – Compétences de bien-être émotionnel
      {
        ...
        description: "Apprendre à reconnaître les sources de stress et adopter des stratégies apaisantes.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Développer la capacité à identifier, verbaliser et partager ses émotions.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
        ...
        description: "Techniques pour moduler l’intensité et la durée des émotions désagréables.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
        ...
        description: "Renforcer sa capacité à rebondir après un échec ou une période difficile.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      {
        ...
        description: "S’entraîner à vivre dans l’instant présent avec attention et bienveillance.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS
      },
      ...
      // SOCIAL_WELLNESS – Compétences de bien-être social
      {
        ...
        description: "Savoir initier et entretenir des relations positives et authentiques.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Apprendre à offrir et demander de l’aide dans les relations sociales.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Exprimer ses besoins et ses limites tout en respectant les autres.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Développer un sentiment d'appartenance par la participation sociale.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      {
        ...
        description: "Apprendre à s’exprimer avec respect et bienveillance dans les échanges.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS
      },
      ...
      },
      {
        ...
        description: "Savoir structurer, analyser et synthétiser l’information.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
      ...
      },
      {
        ...
        description: "Encourager l’exploration d’idées nouvelles et originales.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      {
        ...
        description: "Savoir lire avec discernement et réflexion, en questionnant les sources.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.INTELLECTUAL_WELLNESS
      },
      ...
      // FINANCIAL_WELLNESS – Compétences de bien-être financier
      {
        ...
        description: "Apprendre à planifier ses dépenses et équilibrer ses revenus.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Développer des habitudes d’épargne et d’anticipation des imprévus.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      {
        ...
        description: "Faire des choix d’achat éclairés, durables et adaptés à ses moyens.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      {
        ...
        description: "Savoir lire une fiche de paie, un relevé bancaire ou un contrat.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      {
        ...
        description: "Identifier les comportements à risque et mettre en place des stratégies.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS
      },
      ...
      // ENVIRONMENTAL_WELLNESS – Compétences de bien-être environnemental
      {
        ...
        description: "Apprendre les gestes simples pour réduire son impact environnemental.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Savoir trier efficacement ses déchets et comprendre les filières.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
        ...
        description: "Adopter des habitudes pour consommer moins d’énergie au quotidien.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
        ...
        description: "Choisir des moyens de transport plus écologiques et efficaces.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      {
        ...
        description: "Comprendre l’importance des écosystèmes et comment les préserver.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS
      },
      ...
      // SPIRITUAL_WELLNESS – Compétences de bien-être spirituel
      {
        ...
        description: "Pratiques de recentrage et de connexion intérieure, avec ou sans dimension religieuse.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Cultiver la reconnaissance au quotidien pour renforcer l'équilibre intérieur.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      {
        ...
        description: "Développer une sensibilité spirituelle à travers l’observation du vivant.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      {
        ...
        description: "Apprendre à réfléchir au sens de la vie, à la mort et à sa place dans le monde.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS
      },
      ...
      // COGNITIVE_ACTIVITY – Compétences pour les activités cognitives spécifiques
      {
        ...
        description: "Techniques pour entretenir et améliorer sa mémoire à court et long terme.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Développer ses capacités de raisonnement et de résolution de problèmes.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        id: 1858,
        categoryName: "Attention soutenue",
        description: "Exercer sa concentration pour des tâches longues ou complexes.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      {
        ...
        description: "Utiliser l’imagerie mentale pour renforcer l’apprentissage ou la préparation.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY
      },
      ...
      // COGNITIVE_WELLNESS – Compétences de bien-être cognitif
      {
        ...
        description: "Prévenir la surcharge cognitive et favoriser un bon équilibre psychique.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Apprendre à changer de point de vue et à s’adapter à de nouvelles situations.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS
      },
      {
        ...
        description: "Maîtriser les sources d’interruption pour rester concentré.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS
      },
      {
        ...
        description: "Alterner stimulation et récupération pour un cerveau en santé.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS
      },
      ...
      // URBAN_INFRASTRUCTURE – Compétences liées aux infrastructures urbaines
      {
        ...
        description: "Savoir comprendre un plan de ville, une carte de quartier ou un plan de transport.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Reconnaître et interpréter les panneaux d’indication et de signalisation.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      {
        ...
        description: "Connaître les services disponibles dans un quartier et comment y accéder.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      {
        ...
        description: "Savoir identifier les obstacles urbains et les besoins spécifiques (mobilité réduite, poussettes…).",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      {
        ...
        description: "Comprendre les éléments favorisant un environnement sûr et inclusif.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE
      },
      ...
      // TRANSPORTATION – Compétences en mobilité et transport urbain
      {
        ...
        description: "Lire un plan, acheter un ticket, anticiper les correspondances.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Apprendre à se déplacer en sécurité à pied, à vélo ou en trottinette.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      {
        ...
        description: "Choisir le trajet le plus adapté selon les contraintes (temps, accessibilité, coût).",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      {
        ...
        description: "Adapter sa conduite pour consommer moins et réduire son impact.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      {
        ...
        description: "Connaître les règles de base du code de la route et de la cohabitation urbaine.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.TRANSPORTATION
      },
      ...
      // URBAN_ENVIRONMENT – Compétences liées à l’environnement urbain
      {
        ...
        description: "Comprendre les indices de pollution et leurs effets sur la santé.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Reconnaître les espèces végétales et animales en milieu urbain.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      {
        ...
        description: "Savoir comment signaler ou améliorer l’environnement de son quartier.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      {
        ...
        description: "Identifier les nuisances sonores et adopter des comportements préventifs.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      {
        ...
        description: "Comprendre les enjeux environnementaux dans une ville (îlots de chaleur, gestion des espaces verts…).",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT
      },
      ...
      // COMMUNITY_SERVICES – Compétences liées aux services de proximité
      {
        ...
        description: "Savoir localiser et solliciter les structures d’aide (CCAS, PMI, centres sociaux…).",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Comprendre ses droits et savoir vers qui se tourner pour les exercer.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
        ...
        description: "Remplir un dossier, prendre rendez-vous, comprendre un courrier officiel.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      {
      ...
      },
      {
        ...
        description: "Participer à la vie citoyenne via les conseils de quartier ou les initiatives solidaires.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES
      },
      ...
      // WASTE_MANAGEMENT – Compétences liées à la gestion des déchets
      {
        ...
        description: "Identifier les différents types de déchets et leur mode de tri.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Maîtriser les bases du compostage à la maison ou en collectif.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      {
        ...
        description: "Apprendre à produire moins de déchets par des choix de consommation.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      {
      ...
      },
      {
        ...
        description: "Comprendre les spécificités de collecte dans son territoire.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT
      },
      ...
      // COLLABORATION – Compétences en collaboration
      {
        id: 1890,
        categoryName: "Travail en équipe",
        description: "Savoir coopérer efficacement avec d’autres dans un projet commun.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Comprendre les idées des autres sans interrompre ni juger.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
        id: 1892,
        categoryName: "Résolution de conflits",
        description: "Trouver des solutions pacifiques aux désaccords en groupe.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
        ...
        description: "Organiser équitablement les responsabilités au sein d’une équipe.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COLLABORATION
      },
      {
        id: 1894,
        categoryName: "Communication interpersonnelle",
        description: "Transmettre ses idées clairement tout en respectant ses interlocuteurs.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COLLABORATION
      },
      ...
      // PERSONAL_DEVELOPMENT – Compétences en développement personnel
      {
        ...
        description: "Organiser ses journées et prioriser ses tâches efficacement.",
        typeId: ECategoryType.SKILL,
      ...
      // PODCASTS – Compétences liées à l'écoute de contenus audio
      {
        ...
        description: "Suivre un discours sans support visuel en retenant les idées clés.",
        typeId: ECategoryType.SKILL,
      ...
      // INFOGRAPHICS – Compétences en lecture et création de données visuelles
      {
        ...
        description: "Interpréter rapidement des données représentées visuellement.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Stratégies et outils pour optimiser l’acquisition de connaissances.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.EDUCATION
      },
      {
        ...
        description: "Organisation et maintien d’un environnement d’apprentissage positif.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.EDUCATION
      },
      {
        ...
        description: "Approche pour améliorer les capacités intellectuelles et pratiques.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.EDUCATION
      },
      {
      ...
      },
      {
        ...
        description: "Réalisation des tâches domestiques pour maintenir la propreté.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.DAILY_HELP
      },
      {
      ...
      // 🧑‍🤝‍🧑 SOCIAL_SUPPORT 
      {
        id: 1940,
        categoryName: "Écoute active",
        description: "Techniques pour comprendre et soutenir les interlocuteurs.",
        typeId: ECategoryType.SKILL,
      ...
      // 🤝 PSYCHOLOGICAL_SUPPORT 
      {
        ...
        description: "Méthodes pour favoriser l’expression et l’écoute en contexte psychologique.",
        typeId: ECategoryType.SKILL,
      ...
      },
      {
        ...
        description: "Thérapies visant à modifier les pensées et comportements.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PSYCHOLOGICAL_SUPPORT
      },
      ...
      },
      {
        ...
        description: "Administration correcte et sécurisée des traitements prescrits.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.MEDICAL_AID
      },
      {
      ...
      },
      {
        ...
        description: "Accompagnement pour les contrats et procédures locatives.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.HOUSING_SUPPORT
      },
      {
      ...
      },
      {
        ...
        description: "Conseils pour éviter les accidents lors d’efforts physiques.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.PHYSICAL_ACTIVITY
      },
      {
      ...
      },
      {
        ...
        description: "Techniques pour développer les fonctions intellectuelles.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_TRAINING
      },
      {
        id: 1982,
        categoryName: "Résolution de problèmes",
        description: "Stratégies pour aborder et régler des situations complexes.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.COGNITIVE_TRAINING
      },
      {
      ...
      },
      {
        ...
        description: "Distinctions attribuées pour l’engagement environnemental.",
        typeId: ECategoryType.SKILL,
        chapterId: ECategoryChapter.ENVIRONMENTAL_ACHIEVEMENTS
      },
