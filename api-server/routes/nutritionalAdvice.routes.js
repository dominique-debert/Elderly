...
} from '../schemas/nutritionalAdvice.schema.js';
 ...
 */
router.post('/nutrition-advices', validate(nutritionalAdviceSchema), errorHandler, createNutritionalAdvice);
...
*/
router.get('/nutrition-advices', errorHandler, getAllNutritionalAdvices);
 ...
 */
router.get('/nutrition-advices/:id', validate(idParamNutritionalAdviceSchema, 'params'), errorHandler, getNutritionalAdviceById);
 ...
 */
router.put('/nutrition-advices/:id', validate(idParamNutritionalAdviceSchema, 'params'), errorHandler, updateNutritionalAdvice);
 ...
 */
router.delete('/nutrition-advices/:id', validate(idParamNutritionalAdviceSchema, 'params'), errorHandler, deleteNutritionalAdvice);
