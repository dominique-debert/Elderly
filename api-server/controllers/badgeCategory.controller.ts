...
export const createBadgeCategory = async (
  ...
  try {
    const categoryToCreate = await prisma.badgeCategory.create({
      data: req.body
    });
...
export const getBadgeCategoryById = async (
  ...
  try {
    const category = await prisma.badgeCategory.findUnique({
      where: { id }
    });
...
export const updateBadgeCategory = async (
  ...
  try {
    ...
    const categoryToUpdate = await prisma.badgeCategory.update({
      data: req.body,
      where: { id }
    });
