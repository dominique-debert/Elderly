  ...
  await prisma.category.createMany({
    data: [
      ...
      // 1. PHYSICAL (Activités physiques et sportives)
      {
        ...
        description:
          "Programmes écrits pour guider les séances sportives à la maison ou en salle.",
      ...
      },
      {
        ...
        description:
          "Documents pédagogiques expliquant les bases de l’endurance, force, souplesse.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PHYSICAL_ACTIVITY,
      },
      {
        ...
        description:
          "Modèles de planning pour structurer ses activités sportives.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PHYSICAL_ACTIVITY,
      },
      {
        ...
        description:
          "Fiches pratiques sur les postures et échauffements à adopter.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PHYSICAL_ACTIVITY,
      },
      ...
      // 2. COGNITIVE (Fonctions cognitives et intellectuelles)
      {
        ...
        description:
          "Recueils de jeux cognitifs pour entraîner la mémoire et la logique.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Méthodes pratiques pour améliorer l’attention et la concentration.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      {
        ...
        description:
          "Documents explicatifs sur l’organisation, planification, etc.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      {
        ...
        description:
          "Outils pour comprendre et entraîner les différents types de mémoire.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      {
        ...
        description:
          "Articles et résumés vulgarisés sur le cerveau et ses capacités d’adaptation.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      ...
      // 3. SOCIAL (Activités sociales et communautaires)
      {
        ...
        description:
          "Documents pour planifier des activités de groupe ou communautaires.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Techniques pour animer des discussions ou ateliers participatifs.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SOCIAL,
      },
      {
      ...
      },
      {
        ...
        description:
          "Fiches d’activités favorisant la coopération et l’inclusion.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SOCIAL,
      },
      {
        ...
        description:
          "Recueils de suggestions d’initiatives sociales à lancer en groupe.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SOCIAL,
      },
      ...
      },
      {
        ...
        description:
          "Ressources combinant sons, lumières, textures apaisantes.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
        ...
        description:
          "Matériels et idées pour solliciter les sens de manière ludique.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
        ...
        description:
          "Documents adaptés pour comprendre et accompagner l’hypersensibilité.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SENSORY,
      },
      ...
      // 5. PHYSICAL_WELLNESS (Bien-être physique)
      {
        ...
        description:
          "Conseils et routines pour améliorer la qualité du sommeil.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Ressources pour améliorer le confort corporel au travail ou à la maison.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS,
      },
      {
        ...
        description:
          "Exercices guidés pour la gestion du souffle et la détente.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS,
      },
      {
      ...
      },
      {
        ...
        description:
          "Supports d’écriture pour cultiver la reconnaissance et les émotions positives.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS,
      },
      {
        ...
        description:
          "Exercices guidés pour favoriser l’ancrage dans le présent.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS,
      },
      {
        ...
        description:
          "Ressources pour développer une relation bienveillante avec soi-même.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS,
      },
      ...
      // 7. SOCIAL_WELLNESS (Bien-être social)
      {
        ...
        description:
          "Techniques pour améliorer la qualité des interactions sociales.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Compréhension des rôles et interactions dans les collectifs.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS,
      },
      {
        ...
        description:
          "Grilles et questionnaires pour mesurer son intégration sociale.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SOCIAL_WELLNESS,
      },
      ...
      // 8. INTELLECTUAL_WELLNESS (Bien-être intellectuel)
      {
        ...
        description:
          "Activités pour nourrir la curiosité et le développement mental.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Ressources pour comprendre les bases de l’économie personnelle.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS,
      },
      {
        ...
        description:
          "Modèles de tableau pour se fixer des objectifs financiers.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS,
      },
      {
      ...
      },
      {
        ...
        description:
          "Outils pour repérer les signaux d’alerte et agir en amont.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.FINANCIAL_WELLNESS,
      },
      ...
      },
      {
        ...
        description:
          "Infographies et données pour comprendre les enjeux écologiques.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS,
      },
      {
        ...
        description:
          "Ressources sur les bienfaits psychologiques du contact avec la nature.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS,
      },
      {
        ...
        description:
          "Outils pour documenter ses interactions avec l’environnement.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.ENVIRONMENTAL_WELLNESS,
      },
      {
      ...
      // 11. SPIRITUAL_WELLNESS (Bien-être spirituel)
      {
        ...
        description:
          "Outils pour réfléchir à ses valeurs, croyances et objectifs de vie.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Présentations synthétiques des différentes approches spirituelles.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS,
      },
      {
      ...
      },
      {
        ...
        description:
          "Exercices pratiques pour renforcer un état d’esprit positif et reconnaissant.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SPIRITUAL_WELLNESS,
      },
      ...
      },
      {
        ...
        description:
          "Méthodologies pour aborder les défis cognitifs avec méthode.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY,
      },
      {
        ...
        description:
          "Documents expliquant l’attention, la flexibilité mentale et l’inhibition.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Comprendre l’impact du stress sur les capacités mentales.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COGNITIVE_WELLNESS,
      },
      ...
      // 14. URBAN_INFRASTRUCTURE (Problématiques d’infrastructures urbaines)
      {
        ...
        description:
          "Fiches pour évaluer les équipements et leur accessibilité.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Documents explicatifs sur la conception urbaine inclusive.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE,
      },
      {
      ...
      },
      {
        ...
        description:
          "Ressources pour documenter les infrastructures locales avec les habitants.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.URBAN_INFRASTRUCTURE,
      },
      ...
      // 15. TRANSPORTATION (Mobilité et transports urbains)
      {
        ...
        description:
          "Informations sur la marche, le vélo, et les transports collectifs.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "État des lieux et solutions pour les publics à besoins spécifiques.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.TRANSPORTATION,
      },
      {
      ...
      // 16. URBAN_ENVIRONMENT (Espaces verts et environnement urbain)
      {
        ...
        description:
          "Ressources pour identifier et préserver la faune et flore locales.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Informations pour cultiver sur balcons, toits ou friches.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.URBAN_ENVIRONMENT,
      },
      {
      ...
      // 17. COMMUNITY_SERVICES (Services communautaires urbains)
      {
        ...
        description:
          "Répertoires des structures sociales, éducatives et médicales locales.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Outils pour organiser entraide et actions collectives dans le quartier.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES,
      },
      {
      ...
      },
      {
        ...
        description:
          "Informations sur maisons de quartier, centres sociaux, etc.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES,
      },
      {
        ...
        description:
          "Kits pour organiser des conseils citoyens ou réunions publiques.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COMMUNITY_SERVICES,
      },
      ...
      },
      {
        ...
        description:
          "Informations sur les filières et processus de traitement.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT,
      },
      {
        ...
        description:
          "Ressources pour mettre en place un compost partagé ou individuel.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT,
      },
      {
        ...
        description:
          "Grilles pour évaluer et réduire sa production de déchets.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.WASTE_MANAGEMENT,
      },
      ...
      },
      {
        ...
        description:
          "Ressources pour comprendre les bases du numérique, de l’IA ou de l’IoT.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.INNOVATION,
      },
      {
      ...
      },
      {
        ...
        description:
          "Ressources pour se tenir à jour sur les nouvelles tendances.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.INNOVATION,
      },
      {
        ...
        description:
          "Méthodes pour faire émerger des idées nouvelles en groupe.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.INNOVATION,
      },
      ...
      },
      {
        ...
        description:
          "Outils pour penser l’accessibilité et l’adaptation des espaces.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.CONSTRUCTION,
      },
      {
      ...
      // 21. SUSTAINABILITY (Projets environnementaux et durables)
      {
        ...
        description:
          "Ressources pour intégrer des pratiques responsables au quotidien.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Documents explicatifs sur la réutilisation, le recyclage et la réduction des déchets.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SUSTAINABILITY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Méthodologies pour mesurer l’empreinte environnementale d’un projet.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SUSTAINABILITY,
      },
      {
        ...
        description:
          "Études de cas sur des initiatives durables locales ou globales.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.SUSTAINABILITY,
      },
      ...
      // 22. COLLABORATION (Projets collaboratifs)
      {
        ...
        description:
          "Outils pour structurer et animer des projets à plusieurs.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Fiches pour comprendre et mettre en œuvre la prise de décision collective.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COLLABORATION,
      },
      {
        ...
        description:
          "Guides pour utiliser des plateformes de travail en ligne.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COLLABORATION,
      },
      {
        ...
        description:
          "Outils pour améliorer la communication et la coopération.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.COLLABORATION,
      },
      {
      ...
      },
      {
        ...
        description:
          "Fiches d’introspection, tests de personnalité, exercices réflexifs.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PERSONAL_DEVELOPMENT,
      },
      {
      ...
      // 24. GUIDES (Guides et manuels)
      {
        ...
        description:
          "Manuels pratiques pour la vie quotidienne, la santé, le numérique, etc.",
        typeId: ECategoryType.RESOURCE,
      ...
      },
      {
        ...
        description:
          "Instructions visuelles pour apprendre une compétence ou un processus.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.GUIDES,
      },
      {
        ...
        description:
          "Ressources spécifiques pour accompagner une personne en difficulté.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.GUIDES,
      },
      {
      ...
      },
      {
        ...
        description:
          "Ressources traduites pour favoriser l’inclusion des non-francophones.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.GUIDES,
      },
      ...
      },
      {
        ...
        description:
          "Interventions de spécialistes sur des thématiques précises.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.VIDEOS,
      },
      {
        ...
        description:
          "Contenus accessibles pour expliquer un concept rapidement.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.VIDEOS,
      },
      {
      ...
      },
      {
        id: 1309,
        categoryName:
          "Ressources vidéo pour personnes en difficulté de lecture",
      ...
      },
      {
        ...
        description:
          "Capsules racontant des expériences concrètes ou des projets locaux.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PODCASTS,
      },
      {
      ...
      },
      {
        ...
        description:
          "Représentations visuelles pour mieux comprendre les différences entre options.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.INFOGRAPHICS,
      },
      {
        ...
        description:
          "Données géographiques illustrant des problématiques locales ou globales.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.INFOGRAPHICS,
      },
      {
        ...
        description:
          "Frises pour visualiser l’évolution historique d’un sujet.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.INFOGRAPHICS,
      },
      {
      ...
      },
      {
        ...
        description:
          "Textes expliquant les règles de confidentialité, consentement, etc.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.HEALTHCARE,
      },
      {
        ...
        description:
          "Explications simplifiées pour patients et proches aidants.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.HEALTHCARE,
      },
      ...
      },
      {
        ...
        description:
          "Contenus adaptés aux besoins spécifiques (troubles DYS, etc.).",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.EDUCATION,
      },
      {
        ...
        description:
          "Descriptions claires et complètes de nombreuses professions.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.EDUCATION,
      },
      {
      ...
      },
      {
        ...
        description:
          "Comment bénéficier d’un soutien légal gratuit ou à moindre coût.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.ADMINISTRATIVE_HELP,
      },
      {
        id: 1349,
        categoryName:
          "Tutoriels sur l’utilisation des services en ligne publics",
        description:
          "Pas à pas pour naviguer sur les plateformes gouvernementales.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.ADMINISTRATIVE_HELP,
      },
      ...
      },
      {
        ...
        description:
          "Explications claires pour comprendre différentes pathologies.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.PSYCHOLOGICAL_SUPPORT,
      },
      {
      ...
      },
      {
        id: 1353,
        categoryName:
          "Informations sur les réseaux d’écoute et d’accompagnement",
      ...
      },
      {
        ...
        description:
          "Comment utiliser les défibrillateurs, appeler les secours.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.MEDICAL_AID,
      },
      {
      ...
      },
      {
        id: 1361,
        categoryName:
          "Manuels sur les droits des locataires en situation d’urgence",
      ...
      },
      {
        id: 1364,
        categoryName:
          "Fiches pratiques pour l’installation et l’aménagement provisoire",
      ...
      },
      {
        id: 1367,
        categoryName:
          "Fiches sur la conservation et la préparation des aliments donnés",
        description:
          "Pour éviter le gaspillage et assurer la sécurité alimentaire.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.FOOD_AID,
      },
      {
      ...
      },
      {
        id: 1369,
        categoryName:
          "Informations sur les programmes de repas gratuits ou à prix réduit",
      ...
      },
      {
        ...
        description:
          "Techniques de premiers secours adaptées aux situations d’urgence.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.EMERGENCY_SERVICES,
      },
      {
        id: 1374,
        categoryName:
          "Informations sur les services d’intervention spécialisés",
      ...
      },
      {
        id: 1379,
        categoryName:
          "Informations sur les clubs et associations sportives locales",
      ...
      },
      {
        id: 1384,
        categoryName:
          "Informations sur les ateliers et formations en développement intellectuel",
      ...
      },
      {
        id: 1387,
        categoryName:
          "Fiches pratiques sur la lecture des étiquettes nutritionnelles",
      ...
      },
      {
        id: 1388,
        categoryName:
          "Ressources sur la préparation de repas sains et économiques",
      ...
      },
      {
        id: 1389,
        categoryName:
          "Informations sur les recommandations nutritionnelles officielles",
      ...
      },
      {
        id: 1393,
        categoryName:
          "Ressources sur le développement de réseaux sociaux locaux",
      ...
      },
      {
        id: 1394,
        categoryName:
          "Informations sur les dispositifs de soutien à l’engagement citoyen",
      ...
      },
      {
        id: 1402,
        categoryName:
          "Fiches explicatives des différentes catégories de badges",
      ...
      },
      {
        id: 1403,
        categoryName:
          "Ressources sur la reconnaissance officielle des performances",
      ...
      },
      {
        id: 1404,
        categoryName:
          "Informations sur les événements sportifs liés aux badges",
      ...
      },
      {
        id: 1408,
        categoryName:
          "Ressources sur la valorisation des badges dans le parcours personnel",
      ...
      },
      {
        id: 1412,
        categoryName:
          "Fiches pratiques sur le suivi des objectifs nutritionnels",
      ...
      },
      {
        id: 1414,
        categoryName:
          "Informations sur les challenges et programmes récompensés",
      ...
      },
      {
        id: 1418,
        categoryName:
          "Ressources pour valoriser les badges sociaux dans la vie professionnelle",
      ...
      },
      {
        id: 1419,
        categoryName:
          "Informations sur les événements sociaux valorisant les badges",
      ...
      // 48. ENVIRONMENTAL_ACHIEVEMENTS (Badges environnementaux)
      {
        id: 1420,
        categoryName:
          "Guides sur les critères pour gagner un badge environnemental",
      ...
      },
      {
        id: 1423,
        categoryName:
          "Ressources pour organiser et participer à des actions environnementales",
      ...
      },
      {
        id: 1424,
        categoryName:
          "Informations sur la reconnaissance officielle des badges environnementaux",
      ...
      // 49. ENVIRONMENTAL (Activités environnementales)
      {
        id: 1425,
        categoryName:
          "Guides pour la mise en place d’ateliers de sensibilisation",
      ...
      },
      {
        id: 1427,
        categoryName:
          "Fiches pratiques sur la gestion durable des espaces verts",
      ...
      },
      {
        id: 1429,
        categoryName:
          "Informations sur les dispositifs de soutien aux initiatives environnementales",
        description: "Subventions, formations, accompagnement.",
        typeId: ECategoryType.RESOURCE,
        chapterId: ECategoryChapter.ENVIRONMENTAL,
      },
      ...
      // 50. GENERAL (Discussions générales)
      {
        ...
        description:
          "Techniques d’animation, gestion des conflits, écoute active.",
        typeId: ECategoryType.RESOURCE,
      ...
      // 55. MENTAL_HEALTH (Bien-être mental et cognitif)
      {
        id: 1434,
        categoryName:
          "Guides pour créer des espaces de parole sécurisés sur la santé mentale",
      ...
      },
      {
        id: 1435,
        categoryName:
          "Manuels sur les techniques de gestion du stress et de l’anxiété",
      ...
      },
      {
        id: 1436,
        categoryName:
          "Fiches pratiques sur la reconnaissance des troubles psychiques",
      ...
      },
      {
        id: 1437,
        categoryName:
          "Ressources pour orienter vers des professionnels de santé mentale",
      ...
      },
      {
        id: 1438,
        categoryName:
          "Informations sur les groupes de soutien et activités collectives",
      ...
      },
      {
        id: 1440,
        categoryName:
          "Fiches pratiques sur la réparation et entretien d’objets quotidiens",
      ...
      },
      {
        id: 1442,
        categoryName:
          "Informations sur les ateliers et formations en artisanat",
      ...
      },
      {
        id: 1449,
        categoryName:
          "Fiches pratiques pour la photographie et retouche d’images",
      ...
      },
      {
        id: 1456,
        categoryName:
          "Informations sur les centres de santé et professionnels médicaux",
      ...
      },
      {
        id: 1461,
        categoryName:
          "Informations sur les événements artistiques locaux et internationaux",
      ...
      },
      {
        id: 1466,
        categoryName:
          "Informations sur les plateformes et outils de discussion",
      ...
      },
      {
        id: 1471,
        categoryName:
          "Informations sur les concours et appels à projets créatifs",
      ...
      // 63. INCLUSION (Inclusion sociale)
      {
        id: 1472,
        categoryName:
          "Guides pour promouvoir l’accessibilité et l’égalité des chances",
      ...
      },
      {
        id: 1474,
        categoryName:
          "Fiches pratiques pour favoriser l’intégration des personnes en situation de handicap",
      ...
      },
      {
        id: 1475,
        categoryName:
          "Ressources pour les initiatives communautaires inclusives",
      ...
      },
      {
        id: 1479,
        categoryName:
          "Ressources pour le soutien psychologique des personnes âgées",
      ...
      },
      {
        id: 1480,
        categoryName:
          "Informations sur les structures d’accueil et services spécialisés",
      ...
      },
      {
        id: 1481,
        categoryName:
          "Informations sur les plateformes et outils pour discussions en ligne",
