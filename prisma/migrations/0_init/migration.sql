-- CreateEnum
CREATE TYPE "enum_cognitive_exercise_category" AS ENUM ('memory', 'attention', 'logic', 'language');

-- CreateEnum
CREATE TYPE "enum_cognitive_exercise_difficulty_level" AS ENUM ('beginner', 'intermediate', 'advanced');

-- CreateEnum
CREATE TYPE "enum_exercise_program_category" AS ENUM ('balance', 'strength', 'flexibility', 'cardio');

-- CreateEnum
CREATE TYPE "enum_exercise_program_difficulty_level" AS ENUM ('beginner', 'intermediate', 'advanced');

-- CreateEnum
CREATE TYPE "enum_nutrition_advice_season" AS ENUM ('spring', 'summer', 'autumn', 'winter');

-- CreateEnum
CREATE TYPE "enum_wellness_badge_category" AS ENUM ('physical', 'cognitive', 'nutrition', 'global');
...
CREATE TABLE "nutrition_advice" (
    ...
    "description" TEXT,
    "category" VARCHAR(50),
    "season" "enum_nutrition_advice_season" NOT NULL,
    "image" VARCHAR(255),
    "created_at" TIMESTAMPTZ(6) NOT NULL,
    "updated_at" TIMESTAMPTZ(6) NOT NULL,

    CONSTRAINT "nutrition_advice_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "user_activity" (
    ...
    "exercise_program_id" INTEGER,
    "cognitive_exercise_id" INTEGER,
    "duration_minutes" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "forum_topic" ADD CONSTRAINT "fk_author" FOREIGN KEY ("author_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "service_completed" ADD CONSTRAINT "fk_helper" FOREIGN KEY ("helper_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
