-- SCHEMA
DROP SCHEMA IF EXISTS "helpy" CASCADE;
CREATE SCHEMA "helpy";
...
CREATE TABLE IF NOT EXISTS "local_service" (  -- Création de la table LOCAL_SERVICE
    ...
    gps_coordinates POINT,    -- gps_coordinates : Coordonnées GPS sous forme de point (latitude, longitude)
