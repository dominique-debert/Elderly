...
const Navbar = () => {
  ...
  if (isLoading && user?.id) return <div className="text-center mt-40">Chargement des notifications...</div>;
  if (isError) return <div className="text-center mt-10 text-red-500">Erreur de chargement des notifications</div>;
          ...
          <div className='flex items-center gap-4'>
            ...
            <div className="relative" ref={notifRef}>
              ...
              {isNotifOpen && (
                ...
                >
                  <NotificationList notifications={Array.isArray(notifications) ? notifications : []} />
                </div>
              )}
            </div>
