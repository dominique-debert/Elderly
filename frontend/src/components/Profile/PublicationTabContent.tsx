    ...
    <Card className="p-4">
      ...
      <div className="flex ml-4 mr-4 mb-0 w-full gap-10">
        <div className="flex flex-col w-full mt-1">
          ...
          <p className="text-sm text-normal text-slate-400 text-justify mt-2">
        ...
        <div className="w-full flex justify-end mt-0">
          <figure>
            <img
              className="max-w-100 lg:max-w-200 mr-4 w-full"
      ...
      <div className="flex ml-4 mb-0 w-full gap-10">
        <div className="flex flex-col w-full mt-1">
          <p className="text-slate-400 text-xs">Publié dans santé</p>
