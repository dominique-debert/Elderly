  ...
  return (
    <Card className="w-full pt-4 gap-2 bg-white dark:bg-card shadow-md">
      ...
      <div className="flex gap-2 mt-1 p-2 mr-4 ml-4 overflow-x-auto">
        <span className="badge badge-sm text-primary dark:bg-blue-200 p-3 rounded-lg">
          Toutes les photos
        </span>
        <span className="badge badge-sm dark:bg-slate-700 dark:text-slate-300 p-3 rounded-lg">
          Hobbies
        </span>
        <span className="badge badge-sm dark:bg-slate-700 dark:text-slate-300 p-3 rounded-lg">
      ...
      <div className="text-base m-6 mb-4 mt-4 dark:text-slate-300">
      ...
      <div className="grid grid-cols-3 gap-5 -mt-4 pt-0 mr-6 ml-6">
        <Card className="p-0 gap-0 shadow-md">
          ...
          />
          <div className="p-5 h-full relative bottom-0 z-10 dark:bg-slate-700 rounded-b-xl">
            <div className="text-sm text-justify dark:text-slate-300">
      ...
      <div className="text-base font-normal m-6 mb-4 mt-8 dark:text-slate-300">
        Réunions familiales
      </div>
      <div className="grid grid-cols-3 gap-5 -mt-4 pt-0 mr-6 ml-6">
        <Card className="p-0 gap-0 shadow-md">
      ...
      <div className="text-base m-6 mb-4 mt-8 dark:text-slate-300">
        Promenades
      </div>
      <div className="grid grid-cols-3 gap-5 -mt-4 pt-0 mr-6 ml-6">
        <Card className="p-0 gap-0 shadow-md">
