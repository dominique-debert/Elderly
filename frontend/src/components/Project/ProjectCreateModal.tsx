...
import { createProjectCategory } from '@/services/projectCategory.service';
...
export const ProjectCreateModal: React.FC<ProjectCreateModalProps> = ({ onClose, onCreated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Catégorie de projet créée');
      onClose();
      onCreated?.(); 
    } catch (error: unknown) {
  ...
  return (
    <dialog className="modal modal-open">
      <div className="modal-box">
        <h3 className="border-b border-base-300 font-medium text-xl">Créer une nouvelle catégorie de projet</h3>
