...
import { CognitiveCreateModal } from './CognitiveCreateModal';
...
export function CognitiveModeSwitcher({ mode, setMode, search, setSearch }: SwitchProps) {
