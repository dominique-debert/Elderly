    ...
    >
      <div className="flex flex-col w-full h-full">
        ...
        <div className="card flex justify-end items-center align-middle bg-pink-50 row-span-2 col-span-2 ml-1">
          ...
          <span>
            <div className="badge bg-orange-400 text-white mt-4 p-4 -rotate-45 lg:text-base">heureux</div>
            <div className="badge bg-red-500 text-white ml-[-15px] p-4 -rotate-12 lg:text-base">en colère</div>
            <div className="badge bg-pink-500 text-white ml-[-15px] p-4 rotate-90 lg:text-base">inspiré</div>
          </span>
          <span>
