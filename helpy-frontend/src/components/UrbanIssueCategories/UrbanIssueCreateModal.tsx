...
import { createUrbanIssueCategory } from '@/services/urbanIssueCategory.service';
...
export const UrbanIssueCreateModal: React.FC<UrbanIssueCreateModalProps> = ({ onClose, onCreated }) => {
