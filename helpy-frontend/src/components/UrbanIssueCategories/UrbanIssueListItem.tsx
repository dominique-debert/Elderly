...
export default function UrbanIssueListItem({ urbanIssueCategory }: { urbanIssueCategory: ICategory }) {
  ...
  return (
    <>
      <li
        key={urbanIssueCategory.id}
        className="p-4 rounded shadow-md flex items-center gap-4"
      >
        <span className="w-1/2 font-semibold">{urbanIssueCategory.categoryName}</span>
        <span className="w-full">{urbanIssueCategory.description}</span>
