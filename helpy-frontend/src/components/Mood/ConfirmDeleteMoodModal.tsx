...
import { deleteMood } from '../../services/moods.service'; // à créer si ce n'est pas fait
...
export function ConfirmDeleteMoodModal({ mood, onClose, onConfirm }: ConfirmDeleteMoodModalProps) {
  ...
  return (
    <dialog className="modal modal-open">
      <div className="modal-box">
        ...
        <p className="py-4">Confirmer la suppression de <strong>{mood.name}</strong> ?</p>
