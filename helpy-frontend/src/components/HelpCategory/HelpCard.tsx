...
type HelpCardProps = {
  helpCategory: ICategory;
};

export function HelpCard({ helpCategory }: HelpCardProps) {
  ...
  <>
    <div
      ...
      <div className="flex items-center justify-between w-full mt-2">
        <p className="text-xl font-semibold mb-2"> {helpCategory.categoryName}</p>
      </div>
      <p className="text-sm text-gray-600">
      {helpCategory.description && <p className="mt-2">{helpCategory.description}</p>}
      </p>
