...
import { CognitionCreateModal } from './CognitionCreateModal';
...
export function CognitionListSwitcher({ mode, setMode, search, setSearch }: SwitchProps) {
    ...
    <>
      <div className="flex flex-wrap items-center justify-end gap-4 mb-4 sticky top-2 z-40">
        ...
        <label className="input flex items-center gap-2">
          ...
          <input
            type="search"
            placeholder="Rechercher une catégorie cognitive..."
            className="grow"
            value={search}
