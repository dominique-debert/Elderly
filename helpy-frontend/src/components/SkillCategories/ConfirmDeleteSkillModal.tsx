...
export function ConfirmDeleteSkillModal({ category, onClose, onConfirm }: ConfirmDeleteCategoryModalProps) {
  ...
  return (
    <dialog className="modal modal-open">
      <div className="modal-box">
        <h3 className="font-bold text-lg">Supprimer la catégorie de compétence</h3>
