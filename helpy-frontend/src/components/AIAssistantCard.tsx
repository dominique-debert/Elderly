          ...
          <figure className="rounded-xl relative no-border w-full h-full">
            ...
            <div className="absolute">
              <div className="bg-pink-200 border-8 border-white opacity-80 text-black rounded-full text-md font-normal cursor-pointer">
                <div className="text-center text-pretty font-normal pl-12 pr-12 pt-9 pb-20">Envie de<br/>parler ?
                  <Icon path={mdiMicrophoneOutline}
                    title="Parler"
                    size={2}
                    className="text-white absolute p-2 top-[100px] left-[62px] mt-1 btn-circle bg-indigo-950 hover:bg-indigo-400"
                    />
                </div>
              </div>
            </div>
