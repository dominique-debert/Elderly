...
export function ConfirmDeleteCognitionModal({ category, onClose, onConfirm }: ConfirmDeleteCategoryModalProps) {
  const handleDelete = async () => {
    try {
      await deleteCognitiveCategory(Number(category.id));
