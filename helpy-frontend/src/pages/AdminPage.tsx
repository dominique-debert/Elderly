...
const AdminPage = () => {
  ...
  return (
    <div className="admin-container p-5 w-full h-full flex">
      {user && user.isAdmin ? (
      <>
        <ul className="menu bg-base-100 lg:menu-horizontal rounded-box w-full">
          <li>
            <a>
              <Icon path={mdiHeartSettingsOutline}
                size={0.8}
