...
export const createServiceCategory = async (category: { categoryName: string; description?: string; chapterId: number; typeId: number }) => {
...
export const updateServiceCategory = async (id: string, data: { categoryName: string; description?: string }) => {
