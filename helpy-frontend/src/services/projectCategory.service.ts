...
export const createProjectCategory = async (category: { categoryName: string; description?: string; chapterId: number; typeId: number }) => {
...
export const updateProjectCategory = async (id: string, data: { categoryName: string; description?: string }) => {
