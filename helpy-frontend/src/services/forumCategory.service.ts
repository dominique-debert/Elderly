...
export const createForumCategory = async (category: { categoryName: string; description?: string; chapterId: number; typeId: number }) => {
...
export const updateForumCategory = async (id: string, data: { categoryName: string; description?: string }) => {
