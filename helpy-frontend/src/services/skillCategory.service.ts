...
export const createSkillCategory = async (category: { categoryName: string; description?: string; chapterId: number; typeId: number }) => {
...
export const updateSkillCategory = async (id: string, data: { categoryName: string; description?: string }) => {
