...
async function main() {
  ...
  // Create forum sections
  const generalSection = await prisma.forumSection.upsert({
    where: { id: 1 },
    update: {},
    create: {
      id: 1,
  ...
  const helpSection = await prisma.forumSection.upsert({
    where: { id: 2 },
    update: {},
    create: {
      id: 2,
  ...
  const hobbiesSection = await prisma.forumSection.upsert({
    where: { id: 3 },
    update: {},
    create: {
      id: 3,
  ...
  const techSection = await prisma.forumSection.upsert({
    where: { id: 4 },
    update: {},
    create: {
      id: 4,
  ...
  const healthSection = await prisma.forumSection.upsert({
    where: { id: 5 },
    update: {},
    create: {
      id: 5,
  ...
  console.log("✅ Sections de forum créées");
  ...
  console.log("- 5 sections de forum créées");
