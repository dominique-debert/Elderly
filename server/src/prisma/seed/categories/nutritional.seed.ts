  ...
  await prisma.category.createMany({
    data: [
      ...
      // 🏃 PHYSICAL (Activités physiques et sportives)
      {
        ...
        description:
          "Alimentation optimisée pour l’endurance, la force ou la récupération.",
      ...
      },
      {
        ...
        description:
          "Sélection d’encas sains et riches pour soutenir l’effort.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.PHYSICAL,
      },
      {
      ...
      },
      {
        ...
        description:
          "Alimentation favorisant la prévention des troubles cognitifs.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      {
      ...
      },
      {
        ...
        description:
          "Activités collectives pour favoriser l’équilibre alimentaire.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.SOCIAL,
      },
      ...
      },
      {
        ...
        description:
          "Préparation pour personnes à besoins sensoriels particuliers.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
        ...
        description:
          "Apprendre à reconnaître et apprécier des saveurs variées.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
        ...
        description:
          "Intégration de couleurs, odeurs, sons dans l’expérience alimentaire.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Approche pour prévenir douleurs musculaires ou inflammations.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS,
      },
      {
      ...
      },
      {
        ...
        description:
          "Impact du moment des repas sur les performances cognitives.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY,
      },
      {
        ...
        description:
          "Encadrer les pauses avec des aliments riches en nutriments cognitifs.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY,
      },
      {
        ...
        description:
          "Focus sur les nutriments stimulant les capacités d’apprentissage.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.COGNITIVE_ACTIVITY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Prévention de la compensation émotionnelle par la nourriture.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.EMOTIONAL_WELLNESS,
      },
      {
      ...
      },
      {
        ...
        description:
          "Apprendre à respecter les choix nutritionnels des autres.",
        typeId: ECategoryType.NUTRITION,
        chapterId: ECategoryChapter.DISCUSSIONS,
      },
      {
