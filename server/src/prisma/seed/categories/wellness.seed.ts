  ...
  await prisma.category.createMany({
    data: [
      ...
      // Stretching : Étirements pour prévenir les blessures et améliorer la mobilité.
      {
        ...
        description:
          "Exercices visant à améliorer l’endurance cardiovasculaire.",
      ...
      // 2. COGNITIVE (🧠)
      {
        ...
        description:
          "Activités pour stimuler le raisonnement et la résolution de problèmes.",
        typeId: ECategoryType.WELLNESS,
      ...
      },
      {
        ...
        description:
          "Ateliers pour enrichir le vocabulaire et la communication.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.COGNITIVE,
      },
      ...
      },
      {
        ...
        description:
          "Utilisation de la musique pour stimuler les sens et apaiser.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Stimulations pour améliorer la vision et la reconnaissance.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.SENSORY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Utilisation des huiles essentielles pour apaiser le corps.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.PHYSICAL_WELLNESS,
      },
      ...
      // 6. EMOTIONAL_WELLNESS (😊)
      {
        ...
        description:
          "Ateliers pour mieux identifier et exprimer ses sentiments.",
        typeId: ECategoryType.WELLNESS,
      ...
      // 20. CONSTRUCTION (🛠️)
      {
        ...
        description:
          "Projets pour améliorer l’isolation et réduire la consommation.",
        typeId: ECategoryType.WELLNESS,
      ...
      },
      {
        ...
        description:
          "Encouragement à la réutilisation et réduction du gaspillage.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.SUSTAINABILITY,
      },
      {
      ...
      },
      {
        ...
        description:
          "Aide à l’adaptation du logement pour personnes vulnérables.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.HOUSING_SUPPORT,
      },
      {
      ...
      },
      {
        ...
        description:
          "Techniques pour stimuler l’imagination et raconter des histoires.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.CREATIVE_SKILL,
      },
      {
      ...
      },
      {
        ...
        description:
          "Apprentissage des styles et techniques d’écriture artistique.",
        typeId: ECategoryType.WELLNESS,
        chapterId: ECategoryChapter.ARTISTIC,
      },
      {
      ...
      // 64. ELDERLY_SUPPORT
      {
        ...
        description:
          "Services pour aider les personnes âgées dans leur quotidien.",
        typeId: ECategoryType.WELLNESS,
