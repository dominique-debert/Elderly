...
import { conversationParticipantSchema, idParamConversationParticipantSchema } from '../validators/conversationParticipant.validator';
import { createConversationParticipant, getAllConversationParticipants, getConversationParticipantById, updateConversationParticipant, deleteConversationParticipant } from '@/controllers/index.controller';
const router = Router();
/**
 * @swagger
 ...
 */
router.post('/', validate(conversationParticipantSchema), createConversationParticipant);
/**
 * @swagger
 * /api/conversations-participants:
 *   get:
 ...
 */
router.get('/:id', validate(idParamConversationParticipantSchema, 'params'), getConversationParticipantById);
/**
 * @swagger
 * /api/conversations-participants/{id}:
 *   put:
 ...
 *         description: Participant de conversation non trouvé
 */
router.put('/:id', validate(idParamConversationParticipantSchema, 'params'), updateConversationParticipant);
/**
 * @swagger
 * /api/conversations-participants/{id}:
 *   delete:
 ...
 *         description: Participant de conversation non trouvé
 */
router.delete('/:id', validate(idParamConversationParticipantSchema, 'params'), deleteConversationParticipant);
