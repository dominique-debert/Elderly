...
import { wellnessBadgeSchema, idParamWellnessBadgeSchema } from '../validators/wellnessBadge.validator';
import { createWellnessBadge, getAllWellnessBadges, getWellnessBadgeById, updateWellnessBadge, deleteWellnessBadge, } from '@/controllers/index.controller';
const router = Router();
/**
 * @swagger
 * /api/wellness-badges:
