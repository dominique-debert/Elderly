...
import { createActivity, getAllActivities, getActivityById, updateActivity, deleteActivity, } from '@/controllers/index.controller';
import { activitySchema, idParamActivitySchema } from '../validators/activity.validator';
const router = Router();
