...
import { conversationSchema, idParamConversationSchema } from '../validators/conversation.validator';
import { createConversation, getAllConversations, getConversationById, updateConversation, deleteConversation } from '@/controllers/index.controller';
const router = Router();
/**
 * @swagger
 * /api/conversations:
 ...
 */
router.get('/:id', validate(idParamConversationSchema, 'params'), getConversationById);
/**
 * @swagger
 * /api/conversations/{id}:
 *   put:
 ...
 *         description: Conversation non trouvée
 */
router.put('/:id', validate(idParamConversationSchema, 'params'), updateConversation);
/**
 * @swagger
 * /api/conversations/{id}:
 *   delete:
 ...
 *         description: Conversation non trouvée
 */
router.delete('/:id', validate(idParamConversationSchema, 'params'), deleteConversation);
