...
import { createActivityRegistration, getAllActivityRegistrations, getActivityRegistrationById, updateActivityRegistration, deleteActivityRegistration } from '@/controllers/index.controller';
const router = Router();
/**
 * @swagger
 * tags:
