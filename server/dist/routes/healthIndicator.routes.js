...
import { healthIndicatorSchema, idParamHealthIndicatorSchema } from '../validators/healthIndicator.validator';
import { createHealthIndicator, getAllHealthIndicators, getHealthIndicatorById, updateHealthIndicator, deleteHealthIndicator } from '@/controllers/index.controller';
const router = Router();
/**
 * @swagger
 ...
 */
router.get('/:id', validate(idParamHealthIndicatorSchema, 'params'), getHealthIndicatorById);
/**
 * @swagger
 * /api/health-indicators/{id}:
 *   put:
 ...
 *         description: Indicateur non trouvé
 */
router.put('/:id', validate(idParamHealthIndicatorSchema, 'params'), updateHealthIndicator);
/**
 * @swagger
 * /api/health-indicators/{id}:
 *   delete:
 ...
 *         description: Indicateur non trouvé
 */
router.delete('/:id', validate(idParamHealthIndicatorSchema, 'params'), deleteHealthIndicator);
