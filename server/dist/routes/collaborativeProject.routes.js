...
import { projectSchema, idParamProjectSchema } from '../validators/collaborativeProject.validator';
import { createCollaborativeProject, getAllCollaborativeProjects, getCollaborativeProjectById, updateCollaborativeProject, deleteCollaborativeProject } from '@/controllers/index.controller';
const router = Router();
/**
 * @swagger
 ...
 */
router.get('/:id', validate(idParamProjectSchema, 'params'), getCollaborativeProjectById);
/**
 * @swagger
 * /api/collaborative-projects/{id}:
 *   put:
 ...
 *         description: Projet non trouvé
 */
router.put('/:id', validate(idParamProjectSchema, 'params'), updateCollaborativeProject);
/**
 * @swagger
 * /api/collaborative-projects/{id}:
 *   delete:
 ...
 *         description: Projet non trouvé
 */
router.delete('/:id', validate(idParamProjectSchema, 'params'), deleteCollaborativeProject);
