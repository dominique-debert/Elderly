 ...
 */
export const createHealthIndicator = async (req, res, next) => {
    try {
...
export const getAllHealthIndicators = async (req, res, next) => {
    try {
...
export const getHealthIndicatorById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const updateHealthIndicator = async (req, res, next) => {
    const { id } = req.params;
    try {
        const healthIndicator = await prisma.healthIndicator.findUnique({
            where: { id }
...
export const deleteHealthIndicator = async (req, res, next) => {
    const { id } = req.params;
    try {
        const healthIndicator = await prisma.healthIndicator.findUnique({
            where: { id }
