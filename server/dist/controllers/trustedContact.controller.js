 ...
 */
export const createTrustedContact = async (req, res, next) => {
    try {
...
export const getAllTrustedContacts = async (req, res, next) => {
    try {
...
export const getTrustedContactById = async (req, res, next) => {
    const { id } = req.params;
    try {
