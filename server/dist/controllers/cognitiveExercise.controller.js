 ...
 */
export const createCognitiveExercise = async (req, res, next) => {
    try {
...
export const getAllCognitiveExercises = async (req, res, next) => {
    try {
...
export const getCognitiveExerciseById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const updateCognitiveExercise = async (req, res, next) => {
    const { id } = req.params;
    try {
        const exercise = await prisma.cognitiveExercise.findUnique({
            where: { id }
...
export const deleteCognitiveExercise = async (req, res, next) => {
    const { id } = req.params;
    try {
        const exercise = await prisma.cognitiveExercise.findUnique({
            where: { id }
