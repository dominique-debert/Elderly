 ...
 */
export const createLocalService = async (req, res, next) => {
    try {
...
export const getAllLocalServices = async (req, res, next) => {
    try {
...
export const getLocalServiceById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const updateLocalService = async (req, res, next) => {
    const { id } = req.params;
    try {
        const service = await prisma.localService.findUnique({
            where: { id }
...
export const deleteLocalService = async (req, res, next) => {
    const { id } = req.params;
    try {
        const service = await prisma.localService.findUnique({
            where: { id }
