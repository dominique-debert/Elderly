...
export const fetchAllWellnessCategories = async (req, res, next) => {
    try {
...
export const fetchWellnessCategoryById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const createWellnessCategory = async (req, res, next) => {
    try {
...
export const updateWellnessCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const deleteWellnessCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
        const category = await prisma.category.findUnique({
            where: {
