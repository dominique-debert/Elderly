...
export const fetchAllNutritionCategories = async (req, res, next) => {
    try {
...
export const fetchNutritionCategoryById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const createNutritionCategory = async (req, res, next) => {
    try {
...
export const updateNutritionCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const deleteNutritionCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
        const category = await prisma.category.findUnique({
            where: {
