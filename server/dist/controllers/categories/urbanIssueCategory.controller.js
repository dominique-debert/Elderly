...
export const fetchAllUrbanIssueCategories = async (req, res, next) => {
    try {
...
export const fetchUrbanIssueCategoryById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const createUrbanIssueCategory = async (req, res, next) => {
    try {
...
export const updateUrbanIssueCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const deleteUrbanIssueCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
        const category = await prisma.category.findUnique({
            where: {
