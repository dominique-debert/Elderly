...
export const fetchAllProgramCategories = async (req, res, next) => {
    try {
...
export const fetchProgramCategoryById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const createProgramCategory = async (req, res, next) => {
    try {
...
export const updateProgramCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const deleteProgramCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
        const category = await prisma.category.findUnique({
            where: {
