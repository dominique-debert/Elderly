...
export const fetchAllProjectCategories = async (req, res, next) => {
    try {
...
export const fetchProjectCategoryById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const updateProjectCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const deleteProjectCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
        const category = await prisma.category.findUnique({
            where: {
