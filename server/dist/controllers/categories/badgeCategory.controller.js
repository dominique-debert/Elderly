...
export const fetchAllBadgeCategories = async (req, res, next) => {
    try {
...
export const fetchBadgeCategoryById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const createBadgeCategory = async (req, res, next) => {
    try {
...
export const updateBadgeCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const deleteBadgeCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
        const category = await prisma.category.findUnique({
            where: {
