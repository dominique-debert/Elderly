...
export const fetchAllCognitiveCategories = async (req, res, next) => {
    try {
...
export const fetchCognitiveCategoryById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const createCognitiveCategory = async (req, res, next) => {
    try {
...
export const updateCognitiveCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const deleteCognitiveCategory = async (req, res, next) => {
    const { id } = req.params;
    try {
        const category = await prisma.category.findUnique({
            where: {
