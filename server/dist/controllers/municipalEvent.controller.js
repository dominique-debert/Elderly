 ...
 */
export const createMunicipalEvent = async (req, res, next) => {
    try {
...
export const getAllMunicipalEvents = async (req, res, next) => {
    try {
...
export const getMunicipalEventById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const updateMunicipalEvent = async (req, res, next) => {
    const { id } = req.params;
    try {
        const municipalEvent = await prisma.municipalEvent.findUnique({
            where: { id }
...
export const deleteMunicipalEvent = async (req, res, next) => {
    const { id } = req.params;
    try {
        const municipalEvent = await prisma.municipalEvent.findUnique({
            where: { id }
