...
*/
export const createWellnessBadge = async (req, res, next) => {
    try {
...
export const getAllWellnessBadges = async (req, res, next) => {
    try {
...
export const getWellnessBadgeById = async (req, res, next) => {
    const { id } = req.params;
    try {
...
export const updateWellnessBadge = async (req, res, next) => {
    const { id } = req.params;
    try {
        const wellnessBadge = await prisma.wellnessBadge.findUnique({
            where: { id },
...
export const deleteWellnessBadge = async (req, res, next) => {
    const { id } = req.params;
    try {
        const wellnessBadge = await prisma.wellnessBadge.findUnique({
            where: { id },
