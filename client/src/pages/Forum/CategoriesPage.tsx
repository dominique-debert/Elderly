        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-2">
              <div className="flex items-center justify-between gap-4 p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-700">
                <div className="flex items-center gap-3">
                  ...
                  <a
                    className="text-sm font-medium text-slate-800 dark:text-slate-200 hover:text-primary"
                    href="#"
                  >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto">
              <table className="w-full table-zebra table-fixed text-sm text-left text-slate-500 dark:text-slate-400">
                <thead className="text-sm text-slate-700 bg-slate-50 dark:bg-slate-700 dark:text-slate-400">
                  <tr>
                    ...
                    <th className="text-sm p-4 text-center" scope="col">
                      <span>Statut</span>
                    </th>
                    <th className="text-sm px-6 py-3" scope="col">
                      <span>Modérateurs</span>
                    </th>
                    <th className="px-6 py-3 text-sm text-center" scope="col">
                      <span>Action</span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr className="bg-white dark:bg-slate-800/50 border-b dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50">
                    ...
                    <td className="text-center">
                      <span className="badge badge-info badge-sm">Nouveau</span>
                    </td>
            ...
            <nav className="flex items-center justify-center gap-2 pt-4">
              ...
              <a
                className="text-sm inline-flex size-8 items-center justify-center rounded-lg border border-primary bg-primary text-white"
                href="#"
              >
                1
              </a>
              <a
                className="text-sm inline-flex size-8 items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700/50"
                href="#"
              >
                2
              </a>
