    ...
    <>
      ...
      <div className="flex-1 mt-22 mr-4 mb-8">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="flex flex-col gap-2 rounded-3xl p-6 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10">
            <p className="dark:text-gray-300 text-base h-12 font-medium leading-normal">
          ...
          <div className="flex flex-col gap-2 rounded-3xl p-6 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10">
            <p className="text-base h-12 font-medium leading-normal">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <div className="relative w-full sm:w-64">
                ...
                <input
                  className="input rounded-3xl w-full pl-10 pr-4 py-2 text-sm bg-white dark:bg-white/5 border-gray-200 dark:border-white/10 text-gray-800 dark:text-gray-300 focus:ring-primary focus:border-primary"
            ...
            <div className="bg-white dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 p-6">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">
                      Retour d'expérience : Expérience de l'application mobile
                    </p>
                    <p className="text-sm text-neutral dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-lg text-success">148</span>
                </div>
                <div className="flex justify-between items-center">
                  <p className="text-gray-800 dark:text-gray-300">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 py-4">
            ...
            <div className="w-72">
              <label className="flex flex-col h-10 w-full">
                <div className="flex w-full flex-1 items-stretch rounded-3xl h-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20">
